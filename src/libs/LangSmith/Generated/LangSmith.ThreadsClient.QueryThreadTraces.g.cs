...
namespace LangSmith
{
    public partial class ThreadsClient
    {
        ...
        private static readonly global::LangSmith.EndPointSecurityRequirement[] s_QueryThreadTracesSecurityRequirements =
            new global::LangSmith.EndPointSecurityRequirement[]
            {                s_QueryThreadTracesSecurityRequirement0,
            };
        ...
        partial void ProcessQueryThreadTracesResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        {
            var __response = await QueryThreadTracesAsResponseAsync(
                threadId: threadId,
                projectId: projectId,
                cursor: cursor,
                filter: filter,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::LangSmith.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::LangSmith.AutoSDKHttpResponse<global::LangSmith.ThreadsQueryThreadTracesResponseBody>> QueryThreadTracesAsResponseAsync(
            string threadId,
            global::System.Guid projectId,
            string? cursor = default,
            string? filter = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var __authorizations = global::LangSmith.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_QueryThreadTracesSecurityRequirements,
                operationName: "QueryThreadTracesAsync");
            ...
            try
            {
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessQueryThreadTracesResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::LangSmith.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessQueryThreadTracesResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
