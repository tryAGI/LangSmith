...
namespace LangSmith
{
    public partial class EvaluatorsClient
    {
        ...
        private static readonly global::LangSmith.AutoSDKServer[] s_GetEvaluatorSpendServers = new global::LangSmith.AutoSDKServer[]
        ...
        private static readonly global::LangSmith.EndPointSecurityRequirement s_GetEvaluatorSpendSecurityRequirement0 =
        ...
        private static readonly global::LangSmith.EndPointSecurityRequirement[] s_GetEvaluatorSpendSecurityRequirements =
            new global::LangSmith.EndPointSecurityRequirement[]
            {                s_GetEvaluatorSpendSecurityRequirement0,
            };
        partial void PrepareGetEvaluatorSpendArguments(
            ...
            ref string periodStart);
        partial void PrepareGetEvaluatorSpendRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            string? feedbackKey,
            string periodStart);
        partial void ProcessGetEvaluatorSpendResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessGetEvaluatorSpendResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::LangSmith.EvaluatorsGetEvaluatorSpendResponse> GetEvaluatorSpendAsync(
            string periodStart,
        ...
        {
            var __response = await GetEvaluatorSpendAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::LangSmith.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::LangSmith.AutoSDKHttpResponse<global::LangSmith.EvaluatorsGetEvaluatorSpendResponse>> GetEvaluatorSpendAsResponseAsync(
            string periodStart,
            string? groupBy = default,
            string? evaluatorId = default,
            string? sessionId = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareGetEvaluatorSpendArguments(
            ...
            var __authorizations = global::LangSmith.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_GetEvaluatorSpendSecurityRequirements,
                operationName: "GetEvaluatorSpendAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::LangSmith.PathBuilder(
                                ...
                                servers: s_GetEvaluatorSpendServers,
                                defaultBaseUrl: "https://api.smith.langchain.com/"));
                            __pathBuilder
                                .AddOptionalParameter("group_by", groupBy)
                                .AddOptionalParameter("evaluator_id", evaluatorId)
                                .AddOptionalParameter("session_id", sessionId)
                                .AddOptionalParameter("dataset_id", datasetId)
                                ...
                                .AddRequiredParameter("period_start", periodStart)
                                ;
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareGetEvaluatorSpendRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::LangSmith.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::LangSmith.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "GetEvaluatorSpend",
                                methodName: "GetEvaluatorSpendAsync",
                                pathTemplate: "\"/v1/platform/evaluators/spend\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessGetEvaluatorSpendResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::LangSmith.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessGetEvaluatorSpendResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::LangSmith.EvaluatorsGetEvaluatorSpendResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::LangSmith.AutoSDKHttpResponse<global::LangSmith.EvaluatorsGetEvaluatorSpendResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::LangSmith.EvaluatorsGetEvaluatorSpendResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
