...
namespace LangSmith
{
    public partial class ProductfeedbackClient
    {

        private static readonly global::LangSmith.AutoSDKServer[] s_SubmitProductFeedbackServers = new global::LangSmith.AutoSDKServer[]
        ...
        private static readonly global::LangSmith.EndPointSecurityRequirement s_SubmitProductFeedbackSecurityRequirement0 =
        ...
        private static readonly global::LangSmith.EndPointSecurityRequirement[] s_SubmitProductFeedbackSecurityRequirements =
            new global::LangSmith.EndPointSecurityRequirement[]
            {                s_SubmitProductFeedbackSecurityRequirement0,
            };
        partial void PrepareSubmitProductFeedbackArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string? idempotencyKey,
            global::LangSmith.ProductfeedbackCreateRequest request);
        partial void PrepareSubmitProductFeedbackRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string? idempotencyKey,
            global::LangSmith.ProductfeedbackCreateRequest request);
        partial void ProcessSubmitProductFeedbackResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessSubmitProductFeedbackResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
...
#endif
        public async global::System.Threading.Tasks.Task<global::LangSmith.ProductfeedbackProductFeedback> SubmitProductFeedbackAsync(
        ...
        {
            var __response = await SubmitProductFeedbackAsResponseAsync(
        ...
        [global::System.Diagnostics.CodeAnalysis.Experimental(diagnosticId: "LANGSMITH_ALPHA_001")]
#endif
        public async global::System.Threading.Tasks.Task<global::LangSmith.AutoSDKHttpResponse<global::LangSmith.ProductfeedbackProductFeedback>> SubmitProductFeedbackAsResponseAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareSubmitProductFeedbackArguments(
            ...
            var __authorizations = global::LangSmith.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_SubmitProductFeedbackSecurityRequirements,
                operationName: "SubmitProductFeedbackAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::LangSmith.PathBuilder(
                                ...
                                servers: s_SubmitProductFeedbackServers,
            ...
            __httpRequest.Headers.TryAddWithoutValidation("Idempotency-Key", __idempotencyKey);
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareSubmitProductFeedbackRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::LangSmith.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::LangSmith.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "SubmitProductFeedbackAsync",
                                pathTemplate: "\"/api/v1/platform/product-feedbacks\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessSubmitProductFeedbackResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::LangSmith.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessSubmitProductFeedbackResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::LangSmith.ProductfeedbackProductFeedback.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::LangSmith.AutoSDKHttpResponse<global::LangSmith.ProductfeedbackProductFeedback>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::LangSmith.ProductfeedbackProductFeedback.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::LangSmith.ProductfeedbackProductFeedback> SubmitProductFeedbackAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::LangSmith.ProductfeedbackCreateRequest
            {
                Category = category,
                Client = client,
                Message = message,
            ...
            return await SubmitProductFeedbackAsync(
                idempotencyKey: idempotencyKey,
                request: __request,
                requestOptions: requestOptions,
