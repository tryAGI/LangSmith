...
namespace LangSmith
{
    public partial class OrgsClient
    {
        ...
        private static readonly global::LangSmith.AutoSDKServer[] s_UpdateOrgServiceKeyServers = new global::LangSmith.AutoSDKServer[]
        ...
        private static readonly global::LangSmith.EndPointSecurityRequirement s_UpdateOrgServiceKeySecurityRequirement0 =
        ...
        private static readonly global::LangSmith.EndPointSecurityRequirement[] s_UpdateOrgServiceKeySecurityRequirements =
            new global::LangSmith.EndPointSecurityRequirement[]
            {                s_UpdateOrgServiceKeySecurityRequirement0,
            };
        partial void PrepareUpdateOrgServiceKeyArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref global::System.Guid apiKeyId,
            global::LangSmith.APIKeyUpdateRequest request);
        partial void PrepareUpdateOrgServiceKeyRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            global::System.Guid apiKeyId,
            global::LangSmith.APIKeyUpdateRequest request);
        partial void ProcessUpdateOrgServiceKeyResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessUpdateOrgServiceKeyResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::LangSmith.APIKeyGetResponse> UpdateOrgServiceKeyAsync(
            global::System.Guid apiKeyId,
        ...
        {
            var __response = await UpdateOrgServiceKeyAsResponseAsync(
                apiKeyId: apiKeyId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::LangSmith.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::LangSmith.AutoSDKHttpResponse<global::LangSmith.APIKeyGetResponse>> UpdateOrgServiceKeyAsResponseAsync(
            global::System.Guid apiKeyId,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareUpdateOrgServiceKeyArguments(
            ...
            var __authorizations = global::LangSmith.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_UpdateOrgServiceKeySecurityRequirements,
                operationName: "UpdateOrgServiceKeyAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::LangSmith.PathBuilder(
                                path: $"/api/v1/orgs/current/service-keys/{apiKeyId}",
                                baseUri: ResolveBaseUri(
                                servers: s_UpdateOrgServiceKeyServers,
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareUpdateOrgServiceKeyRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::LangSmith.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::LangSmith.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "UpdateOrgServiceKey",
                                methodName: "UpdateOrgServiceKeyAsync",
                                pathTemplate: "$\"/api/v1/orgs/current/service-keys/{apiKeyId}\"",
                                httpMethod: "PATCH",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessUpdateOrgServiceKeyResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::LangSmith.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessUpdateOrgServiceKeyResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
        ...
        public async global::System.Threading.Tasks.Task<global::LangSmith.APIKeyGetResponse> UpdateOrgServiceKeyAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::LangSmith.APIKeyUpdateRequest
            {
                RoleId = roleId,
                OrgRoleId = orgRoleId,
            };

            return await UpdateOrgServiceKeyAsync(
                apiKeyId: apiKeyId,
                request: __request,
                requestOptions: requestOptions,
