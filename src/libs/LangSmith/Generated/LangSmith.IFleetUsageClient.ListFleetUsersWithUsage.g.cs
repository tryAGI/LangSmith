...
namespace LangSmith
{
    public partial interface IFleetUsageClient
    {
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::LangSmith.ApiException"></exception>
        global::System.Threading.Tasks.Task<global::LangSmith.AutoSDKHttpResponse<global::LangSmith.UsageUserUsageResponse>> ListFleetUsersWithUsageAsResponseAsync(
            string startTime,
            string endTime,
            int? limit = default,
            string? sortBy = default,
