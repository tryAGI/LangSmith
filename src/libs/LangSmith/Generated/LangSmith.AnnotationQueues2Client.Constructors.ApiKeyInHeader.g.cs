...
namespace LangSmith
{
    public sealed partial class AnnotationQueues2Client
    {
        /// <inheritdoc cref="AnnotationQueues2Client(global::System.Net.Http.HttpClient?, global::System.Uri?, global::System.Collections.Generic.List{global::LangSmith.EndPointAuthorization}?, bool)"/>

        public AnnotationQueues2Client(
            string apiKey,
        ...
        /// <summary>
        /// Creates an authenticated AnnotationQueues2Client by resolving the configured credential environment variables.
        /// </summary>
        ...
        public static AnnotationQueues2Client CreateFromEnvironment(
            global::System.Net.Http.HttpClient? httpClient = null,
            global::System.Uri? baseUri = null,
            global::System.Collections.Generic.List<global::LangSmith.EndPointAuthorization>? authorizations = null,
            ...
            bool disposeHttpClient = true)
        {
            ...
            var client = new AnnotationQueues2Client(
                httpClient,
                baseUri,
                authorizations,
                options,
        ...
        /// <summary>
        /// Tries to create an authenticated AnnotationQueues2Client by resolving the configured credential environment variables.
        /// </summary>
        ...
        public static bool TryCreateFromEnvironment(
            out AnnotationQueues2Client? client,
            global::System.Net.Http.HttpClient? httpClient = null,
            global::System.Uri? baseUri = null,
            global::System.Collections.Generic.List<global::LangSmith.EndPointAuthorization>? authorizations = null,
            global::LangSmith.AutoSDKClientOptions? options = null,
            bool disposeHttpClient = true)
        {
            ...
            client = new AnnotationQueues2Client(
                httpClient,
                baseUri,
                authorizations,
                options,
