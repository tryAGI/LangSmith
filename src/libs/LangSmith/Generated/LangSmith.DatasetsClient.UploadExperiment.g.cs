            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            if (ReadResponseAsString)
            {
                ...
                try
                {
                    ...
                    return
                        global::LangSmith.ExperimentResultsUploadResult.FromJson(__content, JsonSerializerOptions) ??
            ...
            else
            {
                try
                {
                    ...
                    return
                        await global::LangSmith.ExperimentResultsUploadResult.FromJsonStreamAsync(__content, JsonSerializerOptions).ConfigureAwait(false) ??
