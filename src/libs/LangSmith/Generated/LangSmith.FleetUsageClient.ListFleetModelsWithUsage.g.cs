...
namespace LangSmith
{
    public partial class FleetUsageClient
    {
        ...
        private static readonly global::LangSmith.AutoSDKServer[] s_ListFleetModelsWithUsageServers = new global::LangSmith.AutoSDKServer[]
        ...
        private static readonly global::LangSmith.EndPointSecurityRequirement s_ListFleetModelsWithUsageSecurityRequirement0 =
        ...
        private static readonly global::LangSmith.EndPointSecurityRequirement[] s_ListFleetModelsWithUsageSecurityRequirements =
            new global::LangSmith.EndPointSecurityRequirement[]
            {                s_ListFleetModelsWithUsageSecurityRequirement0,
            };
        partial void PrepareListFleetModelsWithUsageArguments(
        ...
        partial void PrepareListFleetModelsWithUsageRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            string? sortBy,
            string? sortOrder);
        partial void ProcessListFleetModelsWithUsageResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessListFleetModelsWithUsageResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);

        /// <summary>
        /// List fleet models with usage<br/>
        ...
        public async global::System.Threading.Tasks.Task<global::LangSmith.UsageModelUsageResponse> ListFleetModelsWithUsageAsync(
            string startTime,
            string endTime,
            int? limit = default,
        ...
        {
            var __response = await ListFleetModelsWithUsageAsResponseAsync(
                startTime: startTime,
                endTime: endTime,
                limit: limit,
                sortBy: sortBy,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::LangSmith.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::LangSmith.AutoSDKHttpResponse<global::LangSmith.UsageModelUsageResponse>> ListFleetModelsWithUsageAsResponseAsync(
            string startTime,
            string endTime,
            int? limit = default,
            string? sortBy = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareListFleetModelsWithUsageArguments(
            ...
            var __authorizations = global::LangSmith.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_ListFleetModelsWithUsageSecurityRequirements,
                operationName: "ListFleetModelsWithUsageAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::LangSmith.PathBuilder(
                                ...
                                servers: s_ListFleetModelsWithUsageServers,
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareListFleetModelsWithUsageRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::LangSmith.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::LangSmith.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "ListFleetModelsWithUsage",
                                methodName: "ListFleetModelsWithUsageAsync",
                                pathTemplate: "\"/v1/platform/fleet/usage/models\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessListFleetModelsWithUsageResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::LangSmith.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessListFleetModelsWithUsageResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::LangSmith.UsageModelUsageResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::LangSmith.AutoSDKHttpResponse<global::LangSmith.UsageModelUsageResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::LangSmith.UsageModelUsageResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
