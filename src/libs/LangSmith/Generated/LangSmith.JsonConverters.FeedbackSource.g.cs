...
{
    /// <inheritdoc />
    public class FeedbackSourceJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::LangSmith.FeedbackSource>
    {
        /// <inheritdoc />
        public override global::LangSmith.FeedbackSource Read(
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            var discriminatorTypeInfo = typeInfoResolver.GetTypeInfo(typeof(global::LangSmith.FeedbackCreateCoreSchemaFeedbackSourceDiscriminator), options) as global::System.Text.Json.Serialization.Metadata.JsonTypeInfo<global::LangSmith.FeedbackCreateCoreSchemaFeedbackSourceDiscriminator> ??
                            throw new global::System.InvalidOperationException($"Cannot get type info for {nameof(global::LangSmith.FeedbackCreateCoreSchemaFeedbackSourceDiscriminator)}");
            var discriminator = global::System.Text.Json.JsonSerializer.Deserialize(ref readerCopy, discriminatorTypeInfo);

            global::LangSmith.AppFeedbackSource? app = default;
            if (discriminator?.Type == global::LangSmith.FeedbackCreateCoreSchemaFeedbackSourceDiscriminatorType.App)
            {
            ...
            if (discriminator?.Type == global::LangSmith.FeedbackCreateCoreSchemaFeedbackSourceDiscriminatorType.Api)
            {
            ...
            if (discriminator?.Type == global::LangSmith.FeedbackCreateCoreSchemaFeedbackSourceDiscriminatorType.Model)
            {
            ...
            if (discriminator?.Type == global::LangSmith.FeedbackCreateCoreSchemaFeedbackSourceDiscriminatorType.AutoEval)
            {
            ...
            var result = new global::LangSmith.FeedbackSource(
                discriminator?.Type,
                app,
                api,
                model,
        ...
        public override void Write(
            ...
            global::LangSmith.FeedbackSource value,
            global::System.Text.Json.JsonSerializerOptions options)
        {
            options = options ?? throw new global::System.ArgumentNullException(nameof(options));
            var typeInfoResolver = options.TypeInfoResolver ?? throw new global::System.InvalidOperationException("TypeInfoResolver is not set.");
