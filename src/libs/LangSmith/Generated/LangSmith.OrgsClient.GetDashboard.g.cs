            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            if (ReadResponseAsString)
            {
                ...
                try
                {
                    ...
                    return
                        global::LangSmith.OrganizationDashboardSchema.FromJson(__content, JsonSerializerOptions) ??
            ...
            else
            {
                try
                {
                    ...
                    return
                        await global::LangSmith.OrganizationDashboardSchema.FromJsonStreamAsync(__content, JsonSerializerOptions).ConfigureAwait(false) ??
