...
namespace LangSmith
{
    public partial interface IEvaluatorsClient
    {
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::LangSmith.ApiException"></exception>
        global::System.Threading.Tasks.Task<global::LangSmith.AutoSDKHttpResponse<global::LangSmith.EvaluatorsBulkDeleteEvaluatorsResponse>> BulkDeleteEvaluatorsAsResponseAsync(
            global::System.Collections.Generic.IList<string> evaluatorIds,
            bool? deleteRunRules = default,
            global::LangSmith.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default);
