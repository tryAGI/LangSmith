...
namespace LangSmith
{
    public partial class OrgsClient
    {
        ...
        private static readonly global::LangSmith.AutoSDKServer[] s_CreateOrgPersonalAccessTokenServers = new global::LangSmith.AutoSDKServer[]
        ...
        private static readonly global::LangSmith.EndPointSecurityRequirement s_CreateOrgPersonalAccessTokenSecurityRequirement0 =
        ...
        private static readonly global::LangSmith.EndPointSecurityRequirement[] s_CreateOrgPersonalAccessTokenSecurityRequirements =
            new global::LangSmith.EndPointSecurityRequirement[]
            {                s_CreateOrgPersonalAccessTokenSecurityRequirement0,
            };
        ...
        {
            var __response = await CreateOrgPersonalAccessTokenAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::LangSmith.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::LangSmith.AutoSDKHttpResponse<global::LangSmith.APIKeyCreateResponse>> CreateOrgPersonalAccessTokenAsResponseAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var __authorizations = global::LangSmith.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_CreateOrgPersonalAccessTokenSecurityRequirements,
                operationName: "CreateOrgPersonalAccessTokenAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::LangSmith.PathBuilder(
                                ...
                                servers: s_CreateOrgPersonalAccessTokenServers,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::LangSmith.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::LangSmith.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "CreateOrgPersonalAccessToken",
                                methodName: "CreateOrgPersonalAccessTokenAsync",
                ...
                else
                {
                    await global::LangSmith.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            // Insufficient permission, PAT creation is disabled, or the organization blocks API keys from creating other API keys.
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    var __value = global::LangSmith.APIKeyCreateResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::LangSmith.AutoSDKHttpResponse<global::LangSmith.APIKeyCreateResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::LangSmith.APIKeyCreateResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
