...
namespace LangSmith
{
    public partial class ThreadsClient
    {
        ...
        private static readonly global::LangSmith.AutoSDKServer[] s_ReadAThreadsShareStateServers = new global::LangSmith.AutoSDKServer[]
        ...
        private static readonly global::LangSmith.EndPointSecurityRequirement s_ReadAThreadsShareStateSecurityRequirement0 =
        ...
        private static readonly global::LangSmith.EndPointSecurityRequirement[] s_ReadAThreadsShareStateSecurityRequirements =
            new global::LangSmith.EndPointSecurityRequirement[]
            {                s_ReadAThreadsShareStateSecurityRequirement0,
            };
        partial void PrepareReadAThreadsShareStateArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string threadId,
            ref global::System.Guid projectId);
        partial void PrepareReadAThreadsShareStateRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string threadId,
            global::System.Guid projectId);
        partial void ProcessReadAThreadsShareStateResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessReadAThreadsShareStateResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::LangSmith.ThreadshareShareTokenResponseBody> ReadAThreadsShareStateAsync(
            string threadId,
            global::System.Guid projectId,
            global::LangSmith.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await ReadAThreadsShareStateAsResponseAsync(
                threadId: threadId,
                projectId: projectId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::LangSmith.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::LangSmith.AutoSDKHttpResponse<global::LangSmith.ThreadshareShareTokenResponseBody>> ReadAThreadsShareStateAsResponseAsync(
            string threadId,
            global::System.Guid projectId,
            global::LangSmith.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareReadAThreadsShareStateArguments(
            ...
            var __authorizations = global::LangSmith.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_ReadAThreadsShareStateSecurityRequirements,
                operationName: "ReadAThreadsShareStateAsync");
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::LangSmith.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::LangSmith.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "ReadAThreadsShareState",
                                methodName: "ReadAThreadsShareStateAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessReadAThreadsShareStateResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::LangSmith.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessReadAThreadsShareStateResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
