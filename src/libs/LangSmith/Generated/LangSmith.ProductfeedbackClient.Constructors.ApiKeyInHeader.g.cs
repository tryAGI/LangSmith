...
namespace LangSmith
{
    public sealed partial class ProductfeedbackClient
    {
        /// <inheritdoc cref="ProductfeedbackClient(global::System.Net.Http.HttpClient?, global::System.Uri?, global::System.Collections.Generic.List{global::LangSmith.EndPointAuthorization}?, bool)"/>

        public ProductfeedbackClient(
            string apiKey,
        ...
        /// <summary>
        /// Creates an authenticated ProductfeedbackClient by resolving the configured credential environment variables.
        /// </summary>
        ...
        public static ProductfeedbackClient CreateFromEnvironment(
            global::System.Net.Http.HttpClient? httpClient = null,
            global::System.Uri? baseUri = null,
            global::System.Collections.Generic.List<global::LangSmith.EndPointAuthorization>? authorizations = null,
            ...
            bool disposeHttpClient = true)
        {
            ...
            var client = new ProductfeedbackClient(
                httpClient,
                baseUri,
                authorizations,
                options,
        ...
        /// <summary>
        /// Tries to create an authenticated ProductfeedbackClient by resolving the configured credential environment variables.
        /// </summary>
        ...
        public static bool TryCreateFromEnvironment(
            out ProductfeedbackClient? client,
            global::System.Net.Http.HttpClient? httpClient = null,
            global::System.Uri? baseUri = null,
            global::System.Collections.Generic.List<global::LangSmith.EndPointAuthorization>? authorizations = null,
            global::LangSmith.AutoSDKClientOptions? options = null,
            bool disposeHttpClient = true)
        {
            ...
            client = new ProductfeedbackClient(
                httpClient,
                baseUri,
                authorizations,
                options,
