...
namespace LangSmith
{
    public partial class DatasetsClient
    {
        ...
        private static readonly global::LangSmith.AutoSDKServer[] s_ReadGroupedExperimentsServers = new global::LangSmith.AutoSDKServer[]
        ...
        private static readonly global::LangSmith.EndPointSecurityRequirement s_ReadGroupedExperimentsSecurityRequirement0 =
        ...
        private static readonly global::LangSmith.EndPointSecurityRequirement[] s_ReadGroupedExperimentsSecurityRequirements =
            new global::LangSmith.EndPointSecurityRequirement[]
            {                s_ReadGroupedExperimentsSecurityRequirement0,
            };
        partial void PrepareReadGroupedExperimentsArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref global::System.Guid datasetId,
            global::LangSmith.GroupedExperimentsRequest request);
        partial void PrepareReadGroupedExperimentsRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            global::System.Guid datasetId,
            global::LangSmith.GroupedExperimentsRequest request);
        partial void ProcessReadGroupedExperimentsResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessReadGroupedExperimentsResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<string> ReadGroupedExperimentsAsync(
            global::System.Guid datasetId,
        ...
        {
            var __response = await ReadGroupedExperimentsAsResponseAsync(
                datasetId: datasetId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::LangSmith.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::LangSmith.AutoSDKHttpResponse<string>> ReadGroupedExperimentsAsResponseAsync(
            global::System.Guid datasetId,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareReadGroupedExperimentsArguments(
            ...
            var __authorizations = global::LangSmith.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_ReadGroupedExperimentsSecurityRequirements,
                operationName: "ReadGroupedExperimentsAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::LangSmith.PathBuilder(
                                path: $"/api/v1/datasets/{datasetId}/experiments/grouped",
                                baseUri: ResolveBaseUri(
                                servers: s_ReadGroupedExperimentsServers,
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareReadGroupedExperimentsRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::LangSmith.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::LangSmith.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "ReadGroupedExperiments",
                                methodName: "ReadGroupedExperimentsAsync",
                                pathTemplate: "$\"/api/v1/datasets/{datasetId}/experiments/grouped\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessReadGroupedExperimentsResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::LangSmith.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessReadGroupedExperimentsResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            return await ReadGroupedExperimentsAsync(
                datasetId: datasetId,
                request: __request,
                requestOptions: requestOptions,
