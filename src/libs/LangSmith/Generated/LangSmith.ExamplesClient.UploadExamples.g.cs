...
namespace LangSmith
{
    public partial class ExamplesClient
    {
        ...
        private static readonly global::LangSmith.EndPointSecurityRequirement[] s_UploadExamplesSecurityRequirements =
            new global::LangSmith.EndPointSecurityRequirement[]
            {                s_UploadExamplesSecurityRequirement0,
            };
        ...
        {
            var __response = await UploadExamplesAsResponseAsync(
                datasetId: datasetId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::LangSmith.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::LangSmith.AutoSDKHttpResponse<global::LangSmith.ExamplesExamplesCreatedResponse>> UploadExamplesAsResponseAsync(
            global::System.Guid datasetId,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var __authorizations = global::LangSmith.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_UploadExamplesSecurityRequirements,
                operationName: "UploadExamplesAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::LangSmith.PathBuilder(
                                path: $"/api/v1/platform/datasets/{datasetId}/examples",
                         ...
                         __authorization.Location == "Header")
                {
                    __httpRequest.Headers.Add(__authorization.Name, __authorization.Value);
                            ...
                            if (request.x_exampleId_Attachments_name_ != default)
                            {
                                ...
                                __contentx_exampleId_Attachments_name_.Headers.ContentType = new global::System.Net.Http.Headers.MediaTypeHeaderValue(
                                    request.x_exampleId_Attachments_name_name is null
                                        ? "application/octet-stream"
                                        : (global::System.IO.Path.GetExtension(request.x_exampleId_Attachments_name_name) ?? string.Empty).ToLowerInvariant() switch
                                        {
                                            ".aac" => "audio/aac",
                                            ".flac" => "audio/flac",
                                            ".gif" => "image/gif",
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::LangSmith.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::LangSmith.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                pathTemplate: "$\"/api/v1/platform/datasets/{datasetId}/examples\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                    ...
                    await global::LangSmith.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    var __value = global::LangSmith.ExamplesExamplesCreatedResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::LangSmith.AutoSDKHttpResponse<global::LangSmith.ExamplesExamplesCreatedResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::LangSmith.ExamplesExamplesCreatedResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::LangSmith.ExamplesExamplesCreatedResponse> UploadExamplesAsync(
            ...
            string x_exampleId_name,
            global::System.IO.Stream x_exampleId_Inputs,
            string x_exampleId_Inputsname,
            global::System.IO.Stream? x_exampleId_Outputs = default,
            string? x_exampleId_Outputsname = default,
            global::System.IO.Stream? x_exampleId_Attachments_name_ = default,
            string? x_exampleId_Attachments_name_name = default,
            global::LangSmith.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            x_exampleId_Inputs = x_exampleId_Inputs ?? throw new global::System.ArgumentNullException(nameof(x_exampleId_Inputs));
            var request = new global::LangSmith.CreatePlatformDatasetsExamplesRequest
            {
                ...
                x_exampleId_Outputsname = x_exampleId_Outputsname,
                x_exampleId_Attachments_name_ = global::System.Array.Empty<byte>(),
                x_exampleId_Attachments_name_name = x_exampleId_Attachments_name_name,
            };
            PrepareArguments(
                client: HttpClient);
            ...
            foreach (var __authorization in __authorizations)
            {
                         ...
                         __authorization.Location == "Header")
                {
                    __httpRequest.Headers.Add(__authorization.Name, __authorization.Value);
                            ...
                            if (x_exampleId_Attachments_name_ != default)
                            {

                                var __contentx_exampleId_Attachments_name_ = new global::System.Net.Http.StreamContent(x_exampleId_Attachments_name_);
                                __contentx_exampleId_Attachments_name_.Headers.ContentType = new global::System.Net.Http.Headers.MediaTypeHeaderValue(
                                    request.x_exampleId_Attachments_name_name is null
                                        ? "application/octet-stream"
                                        : (global::System.IO.Path.GetExtension(request.x_exampleId_Attachments_name_name) ?? string.Empty).ToLowerInvariant() switch
