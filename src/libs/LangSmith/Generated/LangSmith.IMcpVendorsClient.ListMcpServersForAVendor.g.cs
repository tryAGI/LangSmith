...
namespace LangSmith
{
    public partial interface IMcpVendorsClient
    {
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::LangSmith.ApiException"></exception>
        global::System.Threading.Tasks.Task<global::LangSmith.AutoSDKHttpResponse<global::LangSmith.McpVendorsListMcpGatewaysResponse>> ListMcpServersForAVendorAsResponseAsync(
            string vendorSlug,
            int? limit = default,
            int? offset = default,
            global::LangSmith.AutoSDKRequestOptions? requestOptions = default,
