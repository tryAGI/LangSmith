...
namespace LangSmith
{
    public partial class OauthClient
    {
        ...
        private static readonly global::LangSmith.AutoSDKServer[] s_RegisterAnOAuth2DynamicClientServers = new global::LangSmith.AutoSDKServer[]
        ...
        private static readonly global::LangSmith.EndPointSecurityRequirement s_RegisterAnOAuth2DynamicClientSecurityRequirement0 =
        ...
        private static readonly global::LangSmith.EndPointSecurityRequirement[] s_RegisterAnOAuth2DynamicClientSecurityRequirements =
            new global::LangSmith.EndPointSecurityRequirement[]
            {                s_RegisterAnOAuth2DynamicClientSecurityRequirement0,
            };
        partial void PrepareRegisterAnOAuth2DynamicClientArguments(
            global::System.Net.Http.HttpClient httpClient,
            global::LangSmith.OauthClientRegistrationRequest request);
        partial void PrepareRegisterAnOAuth2DynamicClientRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            global::LangSmith.OauthClientRegistrationRequest request);
        partial void ProcessRegisterAnOAuth2DynamicClientResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessRegisterAnOAuth2DynamicClientResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        {
            var __response = await RegisterAnOAuth2DynamicClientAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::LangSmith.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::LangSmith.AutoSDKHttpResponse<global::LangSmith.OauthClientRegistrationResponse>> RegisterAnOAuth2DynamicClientAsResponseAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareRegisterAnOAuth2DynamicClientArguments(
            ...
            var __authorizations = global::LangSmith.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_RegisterAnOAuth2DynamicClientSecurityRequirements,
                operationName: "RegisterAnOAuth2DynamicClientAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::LangSmith.PathBuilder(
                                ...
                                servers: s_RegisterAnOAuth2DynamicClientServers,
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareRegisterAnOAuth2DynamicClientRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::LangSmith.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::LangSmith.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "RegisterAnOAuth2DynamicClient",
                                methodName: "RegisterAnOAuth2DynamicClientAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessRegisterAnOAuth2DynamicClientResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::LangSmith.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if ((int)__response.StatusCode == 413)
                            {
                                ...
                                global::LangSmith.OauthTokenErrorResponse? __value_413 = null;
                                try
                                {
                                    if (__effectiveReadResponseAsString)
                                    {
                                        __content_413 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                        __value_413 = global::LangSmith.OauthTokenErrorResponse.FromJson(__content_413, JsonSerializerContext);
                                    }
                                    else
                                    {
                                        __content_413 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessRegisterAnOAuth2DynamicClientResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::LangSmith.OauthClientRegistrationResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::LangSmith.AutoSDKHttpResponse<global::LangSmith.OauthClientRegistrationResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::LangSmith.OauthClientRegistrationResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
