...
namespace LangSmith
{
    public partial class IntegrationsClient
    {
        ...
        private static readonly global::LangSmith.AutoSDKServer[] s_UpdateAgentBuilderIntegrationsSettingsServers = new global::LangSmith.AutoSDKServer[]
        ...
        private static readonly global::LangSmith.EndPointSecurityRequirement s_UpdateAgentBuilderIntegrationsSettingsSecurityRequirement0 =
        ...
        private static readonly global::LangSmith.EndPointSecurityRequirement[] s_UpdateAgentBuilderIntegrationsSettingsSecurityRequirements =
            new global::LangSmith.EndPointSecurityRequirement[]
            {                s_UpdateAgentBuilderIntegrationsSettingsSecurityRequirement0,
            };
        partial void PrepareUpdateAgentBuilderIntegrationsSettingsArguments(
            global::System.Net.Http.HttpClient httpClient,
            global::LangSmith.IntegrationsAgentBuilderIntegrationsUpdatePayload request);
        partial void PrepareUpdateAgentBuilderIntegrationsSettingsRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            global::LangSmith.IntegrationsAgentBuilderIntegrationsUpdatePayload request);
        partial void ProcessUpdateAgentBuilderIntegrationsSettingsResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessUpdateAgentBuilderIntegrationsSettingsResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::LangSmith.IntegrationsAgentBuilderIntegrationsPayload> UpdateAgentBuilderIntegrationsSettingsAsync(

            global::LangSmith.IntegrationsAgentBuilderIntegrationsUpdatePayload request,
            global::LangSmith.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await UpdateAgentBuilderIntegrationsSettingsAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::LangSmith.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::LangSmith.AutoSDKHttpResponse<global::LangSmith.IntegrationsAgentBuilderIntegrationsPayload>> UpdateAgentBuilderIntegrationsSettingsAsResponseAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareUpdateAgentBuilderIntegrationsSettingsArguments(
            ...
            var __authorizations = global::LangSmith.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_UpdateAgentBuilderIntegrationsSettingsSecurityRequirements,
                operationName: "UpdateAgentBuilderIntegrationsSettingsAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::LangSmith.PathBuilder(
                                ...
                                servers: s_UpdateAgentBuilderIntegrationsSettingsServers,
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareUpdateAgentBuilderIntegrationsSettingsRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::LangSmith.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::LangSmith.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "UpdateAgentBuilderIntegrationsSettings",
                                methodName: "UpdateAgentBuilderIntegrationsSettingsAsync",
                                pathTemplate: "\"/v1/agent-builder/integrations\"",
                                httpMethod: "PUT",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessUpdateAgentBuilderIntegrationsSettingsResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::LangSmith.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessUpdateAgentBuilderIntegrationsSettingsResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::LangSmith.IntegrationsAgentBuilderIntegrationsPayload.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::LangSmith.AutoSDKHttpResponse<global::LangSmith.IntegrationsAgentBuilderIntegrationsPayload>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::LangSmith.IntegrationsAgentBuilderIntegrationsPayload.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::LangSmith.IntegrationsAgentBuilderIntegrationsUpdatePayload
            {
                ...
                IntegrationsEnabledByDefault = integrationsEnabledByDefault,
            };

            return await UpdateAgentBuilderIntegrationsSettingsAsync(
                request: __request,
                requestOptions: requestOptions,
