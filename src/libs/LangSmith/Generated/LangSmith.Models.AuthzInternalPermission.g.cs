    ...
    public static class AuthzInternalPermissionExtensions
    {
        ...
        public static string ToValueString(this AuthzInternalPermission value)
        {
            return value switch
            {
                ...
                AuthzInternalPermission.CustomAppsCreate => "custom-apps:create",
                AuthzInternalPermission.CustomAppsDelete => "custom-apps:delete",
                AuthzInternalPermission.CustomAppsDownload => "custom-apps:download",
                AuthzInternalPermission.CustomAppsRead => "custom-apps:read",
                AuthzInternalPermission.CustomAppsUpdate => "custom-apps:update",
                AuthzInternalPermission.DatasetsClone => "datasets:clone",
                ...
                AuthzInternalPermission.FeedbackConfigsCreate => "feedback-configs:create",
                AuthzInternalPermission.FeedbackConfigsDelete => "feedback-configs:delete",
                AuthzInternalPermission.FeedbackConfigsUpdate => "feedback-configs:update",
                ...
                AuthzInternalPermission.ModelPriceMapCreate => "model-price-map:create",
                ...
                AuthzInternalPermission.SnapshotsCreate => "snapshots:create",
                AuthzInternalPermission.SnapshotsDelete => "snapshots:delete",
                AuthzInternalPermission.SnapshotsUpdate => "snapshots:update",
                AuthzInternalPermission.WorkspacesManage => "workspaces:manage",
                AuthzInternalPermission.WorkspacesManageKeys => "workspaces:manage-keys",
        ...
        public static AuthzInternalPermission? ToEnum(string value)
        {
            return value switch
            {
                ...
                "custom-apps:create" => AuthzInternalPermission.CustomAppsCreate,
                "custom-apps:delete" => AuthzInternalPermission.CustomAppsDelete,
                "custom-apps:download" => AuthzInternalPermission.CustomAppsDownload,
                "custom-apps:read" => AuthzInternalPermission.CustomAppsRead,
                "custom-apps:update" => AuthzInternalPermission.CustomAppsUpdate,
                "datasets:clone" => AuthzInternalPermission.DatasetsClone,
                ...
                "feedback-configs:create" => AuthzInternalPermission.FeedbackConfigsCreate,
                "feedback-configs:delete" => AuthzInternalPermission.FeedbackConfigsDelete,
                "feedback-configs:update" => AuthzInternalPermission.FeedbackConfigsUpdate,
                ...
                "model-price-map:create" => AuthzInternalPermission.ModelPriceMapCreate,
                ...
                "snapshots:create" => AuthzInternalPermission.SnapshotsCreate,
                "snapshots:delete" => AuthzInternalPermission.SnapshotsDelete,
                "snapshots:update" => AuthzInternalPermission.SnapshotsUpdate,
                "workspaces:manage" => AuthzInternalPermission.WorkspacesManage,
                "workspaces:manage-keys" => AuthzInternalPermission.WorkspacesManageKeys,
