...
namespace LangSmith
{
    public sealed partial class AwsMarketplaceClient
    {
        /// <inheritdoc cref="AwsMarketplaceClient(global::System.Net.Http.HttpClient?, global::System.Uri?, global::System.Collections.Generic.List{global::LangSmith.EndPointAuthorization}?, bool)"/>

        public AwsMarketplaceClient(
            string apiKey,
        ...
        /// <summary>
        /// Creates an authenticated AwsMarketplaceClient by resolving the configured credential environment variables.
        /// </summary>
        ...
        public static AwsMarketplaceClient CreateFromEnvironment(
            global::System.Net.Http.HttpClient? httpClient = null,
            global::System.Uri? baseUri = null,
            global::System.Collections.Generic.List<global::LangSmith.EndPointAuthorization>? authorizations = null,
            ...
            bool disposeHttpClient = true)
        {
            ...
            var client = new AwsMarketplaceClient(
                httpClient,
                baseUri,
                authorizations,
                options,
        ...
        /// <summary>
        /// Tries to create an authenticated AwsMarketplaceClient by resolving the configured credential environment variables.
        /// </summary>
        ...
        public static bool TryCreateFromEnvironment(
            out AwsMarketplaceClient? client,
            global::System.Net.Http.HttpClient? httpClient = null,
            global::System.Uri? baseUri = null,
            global::System.Collections.Generic.List<global::LangSmith.EndPointAuthorization>? authorizations = null,
            global::LangSmith.AutoSDKClientOptions? options = null,
            bool disposeHttpClient = true)
        {
            ...
            client = new AwsMarketplaceClient(
                httpClient,
                baseUri,
                authorizations,
                options,
