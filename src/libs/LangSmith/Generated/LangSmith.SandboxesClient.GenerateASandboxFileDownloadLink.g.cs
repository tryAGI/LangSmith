...
namespace LangSmith
{
    public partial class SandboxesClient
    {
        ...
        private static readonly global::LangSmith.AutoSDKServer[] s_GenerateASandboxFileDownloadLinkServers = new global::LangSmith.AutoSDKServer[]
        ...
        private static readonly global::LangSmith.EndPointSecurityRequirement s_GenerateASandboxFileDownloadLinkSecurityRequirement0 =
        ...
        private static readonly global::LangSmith.EndPointSecurityRequirement[] s_GenerateASandboxFileDownloadLinkSecurityRequirements =
            new global::LangSmith.EndPointSecurityRequirement[]
            {                s_GenerateASandboxFileDownloadLinkSecurityRequirement0,
            };
        partial void PrepareGenerateASandboxFileDownloadLinkArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string name,
            global::LangSmith.SandboxesDownloadURLPayload request);
        partial void PrepareGenerateASandboxFileDownloadLinkRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string name,
            global::LangSmith.SandboxesDownloadURLPayload request);
        partial void ProcessGenerateASandboxFileDownloadLinkResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessGenerateASandboxFileDownloadLinkResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::LangSmith.SandboxesDownloadURLResponse> GenerateASandboxFileDownloadLinkAsync(
            string name,
        ...
        {
            var __response = await GenerateASandboxFileDownloadLinkAsResponseAsync(
                name: name,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::LangSmith.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::LangSmith.AutoSDKHttpResponse<global::LangSmith.SandboxesDownloadURLResponse>> GenerateASandboxFileDownloadLinkAsResponseAsync(
            string name,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareGenerateASandboxFileDownloadLinkArguments(
            ...
            var __authorizations = global::LangSmith.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_GenerateASandboxFileDownloadLinkSecurityRequirements,
                operationName: "GenerateASandboxFileDownloadLinkAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::LangSmith.PathBuilder(
                                path: $"/api/v2/sandboxes/boxes/{name}/download-url",
                                baseUri: ResolveBaseUri(
                                servers: s_GenerateASandboxFileDownloadLinkServers,
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareGenerateASandboxFileDownloadLinkRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::LangSmith.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::LangSmith.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "GenerateASandboxFileDownloadLink",
                                methodName: "GenerateASandboxFileDownloadLinkAsync",
                                pathTemplate: "$\"/api/v2/sandboxes/boxes/{name}/download-url\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessGenerateASandboxFileDownloadLinkResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::LangSmith.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessGenerateASandboxFileDownloadLinkResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::LangSmith.SandboxesDownloadURLResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::LangSmith.AutoSDKHttpResponse<global::LangSmith.SandboxesDownloadURLResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::LangSmith.SandboxesDownloadURLResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::LangSmith.SandboxesDownloadURLResponse> GenerateASandboxFileDownloadLinkAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::LangSmith.SandboxesDownloadURLPayload
            {
                ContentDisposition = contentDisposition,
                ContentType = contentType,
                CspSandboxFlags = cspSandboxFlags,
                CspSourceBundles = cspSourceBundles,
                ExpiresInSeconds = expiresInSeconds,
                Path = path,
            };

            return await GenerateASandboxFileDownloadLinkAsync(
                name: name,
                request: __request,
                requestOptions: requestOptions,
