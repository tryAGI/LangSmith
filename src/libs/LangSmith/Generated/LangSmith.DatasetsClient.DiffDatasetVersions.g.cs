            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            if (ReadResponseAsString)
            {
                ...
                try
                {
                    ...
                    return
                        global::LangSmith.DatasetDiffInfo.FromJson(__content, JsonSerializerOptions) ??
            ...
            else
            {
                try
                {
                    ...
                    return
                        await global::LangSmith.DatasetDiffInfo.FromJsonStreamAsync(__content, JsonSerializerOptions).ConfigureAwait(false) ??
