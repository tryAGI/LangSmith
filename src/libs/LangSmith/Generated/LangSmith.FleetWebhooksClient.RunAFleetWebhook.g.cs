...
namespace LangSmith
{
    public partial class FleetWebhooksClient
    {

        private static readonly global::LangSmith.AutoSDKServer[] s_RunAFleetWebhookServers = new global::LangSmith.AutoSDKServer[]
        ...
        private static readonly global::LangSmith.EndPointSecurityRequirement s_RunAFleetWebhookSecurityRequirement0 =
        ...
        private static readonly global::LangSmith.EndPointSecurityRequirement[] s_RunAFleetWebhookSecurityRequirements =
            new global::LangSmith.EndPointSecurityRequirement[]
            {                s_RunAFleetWebhookSecurityRequirement0,
            };
        partial void PrepareRunAFleetWebhookArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string webhookId,
            object request);
        partial void PrepareRunAFleetWebhookRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string webhookId,
            object request);
        partial void ProcessRunAFleetWebhookResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessRunAFleetWebhookResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::LangSmith.AgentBuilderWebhooksWebhookTestResult> RunAFleetWebhookAsync(
            string webhookId,
        ...
        {
            var __response = await RunAFleetWebhookAsResponseAsync(
                webhookId: webhookId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::LangSmith.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::LangSmith.AutoSDKHttpResponse<global::LangSmith.AgentBuilderWebhooksWebhookTestResult>> RunAFleetWebhookAsResponseAsync(
            string webhookId,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareRunAFleetWebhookArguments(
            ...
            var __authorizations = global::LangSmith.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_RunAFleetWebhookSecurityRequirements,
                operationName: "RunAFleetWebhookAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::LangSmith.PathBuilder(
                                path: $"/v1/platform/fleet-webhooks/{webhookId}/run",
                                baseUri: ResolveBaseUri(
                                servers: s_RunAFleetWebhookServers,
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareRunAFleetWebhookRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::LangSmith.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::LangSmith.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "RunAFleetWebhook",
                                methodName: "RunAFleetWebhookAsync",
                                pathTemplate: "$\"/v1/platform/fleet-webhooks/{webhookId}/run\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessRunAFleetWebhookResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::LangSmith.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessRunAFleetWebhookResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::LangSmith.AgentBuilderWebhooksWebhookTestResult.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::LangSmith.AutoSDKHttpResponse<global::LangSmith.AgentBuilderWebhooksWebhookTestResult>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::LangSmith.AgentBuilderWebhooksWebhookTestResult.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            return await RunAFleetWebhookAsync(
                webhookId: webhookId,
                request: __request,
                requestOptions: requestOptions,
