...
namespace LangSmith
{
    public partial class RunsClient
    {
        ...
        private static readonly global::LangSmith.AutoSDKServer[] s_ShareARunServers = new global::LangSmith.AutoSDKServer[]
        ...
        private static readonly global::LangSmith.EndPointSecurityRequirement s_ShareARunSecurityRequirement0 =
        ...
        private static readonly global::LangSmith.EndPointSecurityRequirement[] s_ShareARunSecurityRequirements =
            new global::LangSmith.EndPointSecurityRequirement[]
            {                s_ShareARunSecurityRequirement0,
            };
        partial void PrepareShareARunArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref global::System.Guid runId,
            global::LangSmith.ShareCreateShareTokenRequestBody request);
        partial void PrepareShareARunRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            global::System.Guid runId,
            global::LangSmith.ShareCreateShareTokenRequestBody request);
        partial void ProcessShareARunResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessShareARunResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        /// <summary>
        /// Share a run<br/>
        /// Creates or returns a share token for a run. Child runs share their trace root.<br/>
        ...
        public async global::System.Threading.Tasks.Task<global::LangSmith.ShareCreateShareTokenResponseBody> ShareARunAsync(
            global::System.Guid runId,
        ...
        {
            var __response = await ShareARunAsResponseAsync(
                runId: runId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::LangSmith.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::LangSmith.AutoSDKHttpResponse<global::LangSmith.ShareCreateShareTokenResponseBody>> ShareARunAsResponseAsync(
            global::System.Guid runId,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var __authorizations = global::LangSmith.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_ShareARunSecurityRequirements,
                operationName: "ShareARunAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::LangSmith.PathBuilder(
                                path: $"/api/v2/runs/{runId}/share",
                                baseUri: ResolveBaseUri(
                                servers: s_ShareARunServers,
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::LangSmith.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::LangSmith.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "ShareARun",
                                methodName: "ShareARunAsync",
                                pathTemplate: "$\"/api/v2/runs/{runId}/share\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                else
                {
                    await global::LangSmith.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if ((int)__response.StatusCode == 413)
                            {
                                ...
                                global::LangSmith.SharedProblemDetails? __value_413 = null;
                                try
                                {
                                    if (__effectiveReadResponseAsString)
                                    {
                                        __content_413 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                        __value_413 = global::LangSmith.SharedProblemDetails.FromJson(__content_413, JsonSerializerContext);
                                    }
                                    else
                                    {
                                        __content_413 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessShareARunResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::LangSmith.ShareCreateShareTokenResponseBody.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::LangSmith.AutoSDKHttpResponse<global::LangSmith.ShareCreateShareTokenResponseBody>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::LangSmith.ShareCreateShareTokenResponseBody.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::LangSmith.ShareCreateShareTokenResponseBody> ShareARunAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::LangSmith.ShareCreateShareTokenRequestBody
            {
                SessionId = sessionId,
                TraceId = traceId,
            };

            return await ShareARunAsync(
                runId: runId,
                request: __request,
                requestOptions: requestOptions,
