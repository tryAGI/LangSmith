...
namespace LangSmith
{
    public partial class SandboxesClient
    {
        ...
        private static readonly global::LangSmith.AutoSDKServer[] s_OpenASandboxTcpTunnelServers = new global::LangSmith.AutoSDKServer[]
        ...
        private static readonly global::LangSmith.EndPointSecurityRequirement s_OpenASandboxTcpTunnelSecurityRequirement0 =
        ...
        private static readonly global::LangSmith.EndPointSecurityRequirement[] s_OpenASandboxTcpTunnelSecurityRequirements =
            new global::LangSmith.EndPointSecurityRequirement[]
            {                s_OpenASandboxTcpTunnelSecurityRequirement0,
            };
        partial void PrepareOpenASandboxTcpTunnelArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string sandboxId,
            ref int? xSandboxPort);
        partial void PrepareOpenASandboxTcpTunnelRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string sandboxId,
            int? xSandboxPort);
        partial void ProcessOpenASandboxTcpTunnelResponse(
            global::System.Net.Http.HttpClient httpClient,
        ...
        public async global::System.Threading.Tasks.Task OpenASandboxTcpTunnelAsync(
            string sandboxId,
            int? xSandboxPort = default,
            global::LangSmith.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            await OpenASandboxTcpTunnelAsResponseAsync(
                sandboxId: sandboxId,
                xSandboxPort: xSandboxPort,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::LangSmith.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::LangSmith.AutoSDKHttpResponse> OpenASandboxTcpTunnelAsResponseAsync(
            string sandboxId,
            int? xSandboxPort = default,
            global::LangSmith.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareOpenASandboxTcpTunnelArguments(
                httpClient: HttpClient,
                sandboxId: ref sandboxId,
                xSandboxPort: ref xSandboxPort);


            var __authorizations = global::LangSmith.EndPointSecurityResolver.ResolveAuthorizations(
                availableAuthorizations: Authorizations,
                securityRequirements: s_OpenASandboxTcpTunnelSecurityRequirements,
                operationName: "OpenASandboxTcpTunnelAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::LangSmith.PathBuilder(
                                path: $"/api/v2/sandboxes/{sandboxId}/tunnel",
                                baseUri: ResolveBaseUri(
                                servers: s_OpenASandboxTcpTunnelServers,
            ...
            if (xSandboxPort != default)
            {
                __httpRequest.Headers.TryAddWithoutValidation("X-Sandbox-Port", xSandboxPort.ToString());
            }
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareOpenASandboxTcpTunnelRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::LangSmith.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::LangSmith.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "OpenASandboxTcpTunnel",
                                methodName: "OpenASandboxTcpTunnelAsync",
                                pathTemplate: "$\"/api/v2/sandboxes/{sandboxId}/tunnel\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessOpenASandboxTcpTunnelResponse(
                    httpClient: HttpClient,
