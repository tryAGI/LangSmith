...
namespace LangSmith
{
    public partial class SandboxesClient
    {
        ...
        private static readonly global::LangSmith.AutoSDKServer[] s_GlobASandboxFilesystemServers = new global::LangSmith.AutoSDKServer[]
        ...
        private static readonly global::LangSmith.EndPointSecurityRequirement s_GlobASandboxFilesystemSecurityRequirement0 =
        ...
        private static readonly global::LangSmith.EndPointSecurityRequirement[] s_GlobASandboxFilesystemSecurityRequirements =
            new global::LangSmith.EndPointSecurityRequirement[]
            {                s_GlobASandboxFilesystemSecurityRequirement0,
            };
        partial void PrepareGlobASandboxFilesystemArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string sandboxId,
            global::LangSmith.SandboxesGlobRequest request);
        partial void PrepareGlobASandboxFilesystemRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string sandboxId,
            global::LangSmith.SandboxesGlobRequest request);
        partial void ProcessGlobASandboxFilesystemResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessGlobASandboxFilesystemResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::LangSmith.SandboxesGlobResponse> GlobASandboxFilesystemAsync(
            string sandboxId,
        ...
        {
            var __response = await GlobASandboxFilesystemAsResponseAsync(
                sandboxId: sandboxId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::LangSmith.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::LangSmith.AutoSDKHttpResponse<global::LangSmith.SandboxesGlobResponse>> GlobASandboxFilesystemAsResponseAsync(
            string sandboxId,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareGlobASandboxFilesystemArguments(
            ...
            var __authorizations = global::LangSmith.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_GlobASandboxFilesystemSecurityRequirements,
                operationName: "GlobASandboxFilesystemAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::LangSmith.PathBuilder(
                                path: $"/api/v2/sandboxes/{sandboxId}/glob",
                                baseUri: ResolveBaseUri(
                                servers: s_GlobASandboxFilesystemServers,
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareGlobASandboxFilesystemRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::LangSmith.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::LangSmith.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "GlobASandboxFilesystem",
                                methodName: "GlobASandboxFilesystemAsync",
                                pathTemplate: "$\"/api/v2/sandboxes/{sandboxId}/glob\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessGlobASandboxFilesystemResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::LangSmith.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessGlobASandboxFilesystemResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::LangSmith.SandboxesGlobResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::LangSmith.AutoSDKHttpResponse<global::LangSmith.SandboxesGlobResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::LangSmith.SandboxesGlobResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::LangSmith.SandboxesGlobResponse> GlobASandboxFilesystemAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::LangSmith.SandboxesGlobRequest
            {
                Limit = limit,
                Path = path,
                Pattern = pattern,
            ...
            return await GlobASandboxFilesystemAsync(
                sandboxId: sandboxId,
                request: __request,
                requestOptions: requestOptions,
