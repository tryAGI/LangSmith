...
{
    /// <summary>
    /// TracerSession stats filtered to runs matching a specific metadata value.<br/>
    /// Extends TracerSession with:<br/>
    /// - example_count: unique examples (vs run_count = total runs including duplicates)<br/>
    /// - filter: ClickHouse filter for fetching runs in this session/group<br/>
...
#endif
        public GroupedRunsSessionStats(
