            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            if (ReadResponseAsString)
            {
                ...
                try
                {
                    ...
                    return
                        global::LangSmith.SessionFeedbackDelta.FromJson(__content, JsonSerializerOptions) ??
            ...
            else
            {
                try
                {
                    ...
                    return
                        await global::LangSmith.SessionFeedbackDelta.FromJsonStreamAsync(__content, JsonSerializerOptions).ConfigureAwait(false) ??
