...
namespace LangSmith
{
    public partial class RunsClient
    {
        ...
        private static readonly global::LangSmith.AutoSDKServer[] s_QueryPublicSharedTraceRunsServers = new global::LangSmith.AutoSDKServer[]
        ...
        private static readonly global::LangSmith.EndPointSecurityRequirement s_QueryPublicSharedTraceRunsSecurityRequirement0 =
        ...
        private static readonly global::LangSmith.EndPointSecurityRequirement[] s_QueryPublicSharedTraceRunsSecurityRequirements =
            new global::LangSmith.EndPointSecurityRequirement[]
            {                s_QueryPublicSharedTraceRunsSecurityRequirement0,
            };
        partial void PrepareQueryPublicSharedTraceRunsArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string? accept,
            ref string? contentType,
            ref global::System.Guid shareToken,
            global::LangSmith.QueryPublicSharedTraceRunsRequestBody request);
        partial void PrepareQueryPublicSharedTraceRunsRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            global::LangSmith.QueryPublicSharedTraceRunsRequestBody request);
        partial void ProcessQueryPublicSharedTraceRunsResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessQueryPublicSharedTraceRunsResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        /// Returns all runs within the trace identified by the share token. The share token supplies the tenant, project, and trace scope.<br/>
        ...
        public async global::System.Threading.Tasks.Task<global::LangSmith.QueryQueryTraceResponseBody> QueryPublicSharedTraceRunsAsync(
            global::System.Guid shareToken,
        ...
        {
            var __response = await QueryPublicSharedTraceRunsAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::LangSmith.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::LangSmith.AutoSDKHttpResponse<global::LangSmith.QueryQueryTraceResponseBody>> QueryPublicSharedTraceRunsAsResponseAsync(
            global::System.Guid shareToken,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareQueryPublicSharedTraceRunsArguments(
            ...
            var __authorizations = global::LangSmith.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_QueryPublicSharedTraceRunsSecurityRequirements,
                operationName: "QueryPublicSharedTraceRunsAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::LangSmith.PathBuilder(
                                path: $"/api/v2/public/{shareToken}/runs/query",
                                baseUri: ResolveBaseUri(
                                servers: s_QueryPublicSharedTraceRunsServers,
            ...
            if (contentType != default)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareQueryPublicSharedTraceRunsRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::LangSmith.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::LangSmith.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "QueryPublicSharedTraceRuns",
                                methodName: "QueryPublicSharedTraceRunsAsync",
                                pathTemplate: "$\"/api/v2/public/{shareToken}/runs/query\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessQueryPublicSharedTraceRunsResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::LangSmith.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            // share token or shared trace not found
                            ...
                            // no V2 backend configured and no V1 proxy fallback
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessQueryPublicSharedTraceRunsResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::LangSmith.QueryQueryTraceResponseBody.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::LangSmith.AutoSDKHttpResponse<global::LangSmith.QueryQueryTraceResponseBody>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::LangSmith.QueryQueryTraceResponseBody.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::LangSmith.QueryQueryTraceResponseBody> QueryPublicSharedTraceRunsAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::LangSmith.QueryPublicSharedTraceRunsRequestBody
            {
                Selects = selects,
            };

            return await QueryPublicSharedTraceRunsAsync(
                accept: accept,
                contentType: contentType,
                shareToken: shareToken,
                request: __request,
