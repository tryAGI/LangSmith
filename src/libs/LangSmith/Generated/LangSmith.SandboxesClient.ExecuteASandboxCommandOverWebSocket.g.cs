...
namespace LangSmith
{
    public partial class SandboxesClient
    {
        ...
        private static readonly global::LangSmith.AutoSDKServer[] s_ExecuteASandboxCommandOverWebSocketServers = new global::LangSmith.AutoSDKServer[]
        ...
        private static readonly global::LangSmith.EndPointSecurityRequirement s_ExecuteASandboxCommandOverWebSocketSecurityRequirement0 =
        ...
        private static readonly global::LangSmith.EndPointSecurityRequirement[] s_ExecuteASandboxCommandOverWebSocketSecurityRequirements =
            new global::LangSmith.EndPointSecurityRequirement[]
            {                s_ExecuteASandboxCommandOverWebSocketSecurityRequirement0,
            };
        partial void PrepareExecuteASandboxCommandOverWebSocketArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string sandboxId);
        partial void PrepareExecuteASandboxCommandOverWebSocketRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string sandboxId);
        partial void ProcessExecuteASandboxCommandOverWebSocketResponse(
            global::System.Net.Http.HttpClient httpClient,
        ...
        public async global::System.Threading.Tasks.Task ExecuteASandboxCommandOverWebSocketAsync(
            string sandboxId,
            global::LangSmith.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            await ExecuteASandboxCommandOverWebSocketAsResponseAsync(
                sandboxId: sandboxId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::LangSmith.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::LangSmith.AutoSDKHttpResponse> ExecuteASandboxCommandOverWebSocketAsResponseAsync(
            string sandboxId,
            global::LangSmith.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareExecuteASandboxCommandOverWebSocketArguments(
            ...
            var __authorizations = global::LangSmith.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_ExecuteASandboxCommandOverWebSocketSecurityRequirements,
                operationName: "ExecuteASandboxCommandOverWebSocketAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::LangSmith.PathBuilder(
                                path: $"/api/v2/sandboxes/{sandboxId}/execute/ws",
                                baseUri: ResolveBaseUri(
                                servers: s_ExecuteASandboxCommandOverWebSocketServers,
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareExecuteASandboxCommandOverWebSocketRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::LangSmith.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::LangSmith.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "ExecuteASandboxCommandOverWebSocket",
                                methodName: "ExecuteASandboxCommandOverWebSocketAsync",
                                pathTemplate: "$\"/api/v2/sandboxes/{sandboxId}/execute/ws\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessExecuteASandboxCommandOverWebSocketResponse(
                    httpClient: HttpClient,
