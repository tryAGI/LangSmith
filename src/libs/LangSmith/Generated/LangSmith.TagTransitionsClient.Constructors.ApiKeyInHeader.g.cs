...
namespace LangSmith
{
    public sealed partial class TagTransitionsClient
    {
        /// <inheritdoc cref="TagTransitionsClient(global::System.Net.Http.HttpClient?, global::System.Uri?, global::System.Collections.Generic.List{global::LangSmith.EndPointAuthorization}?, bool)"/>

        public TagTransitionsClient(
            string apiKey,
        ...
        /// <summary>
        /// Creates an authenticated TagTransitionsClient by resolving the configured credential environment variables.
        /// </summary>
        ...
        public static TagTransitionsClient CreateFromEnvironment(
            global::System.Net.Http.HttpClient? httpClient = null,
            global::System.Uri? baseUri = null,
            global::System.Collections.Generic.List<global::LangSmith.EndPointAuthorization>? authorizations = null,
            ...
            bool disposeHttpClient = true)
        {
            ...
            var client = new TagTransitionsClient(
                httpClient,
                baseUri,
                authorizations,
                options,
        ...
        /// <summary>
        /// Tries to create an authenticated TagTransitionsClient by resolving the configured credential environment variables.
        /// </summary>
        ...
        public static bool TryCreateFromEnvironment(
            out TagTransitionsClient? client,
            global::System.Net.Http.HttpClient? httpClient = null,
            global::System.Uri? baseUri = null,
            global::System.Collections.Generic.List<global::LangSmith.EndPointAuthorization>? authorizations = null,
            global::LangSmith.AutoSDKClientOptions? options = null,
            bool disposeHttpClient = true)
        {
            ...
            client = new TagTransitionsClient(
                httpClient,
                baseUri,
                authorizations,
                options,
