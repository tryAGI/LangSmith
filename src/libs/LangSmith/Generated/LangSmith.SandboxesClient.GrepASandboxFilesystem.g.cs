...
namespace LangSmith
{
    public partial class SandboxesClient
    {
        ...
        private static readonly global::LangSmith.AutoSDKServer[] s_GrepASandboxFilesystemServers = new global::LangSmith.AutoSDKServer[]
        ...
        private static readonly global::LangSmith.EndPointSecurityRequirement s_GrepASandboxFilesystemSecurityRequirement0 =
        ...
        private static readonly global::LangSmith.EndPointSecurityRequirement[] s_GrepASandboxFilesystemSecurityRequirements =
            new global::LangSmith.EndPointSecurityRequirement[]
            {                s_GrepASandboxFilesystemSecurityRequirement0,
            };
        partial void PrepareGrepASandboxFilesystemArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string sandboxId,
            global::LangSmith.SandboxesGrepRequest request);
        partial void PrepareGrepASandboxFilesystemRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string sandboxId,
            global::LangSmith.SandboxesGrepRequest request);
        partial void ProcessGrepASandboxFilesystemResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessGrepASandboxFilesystemResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::LangSmith.SandboxesGrepResponse> GrepASandboxFilesystemAsync(
            string sandboxId,
        ...
        {
            var __response = await GrepASandboxFilesystemAsResponseAsync(
                sandboxId: sandboxId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::LangSmith.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::LangSmith.AutoSDKHttpResponse<global::LangSmith.SandboxesGrepResponse>> GrepASandboxFilesystemAsResponseAsync(
            string sandboxId,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareGrepASandboxFilesystemArguments(
            ...
            var __authorizations = global::LangSmith.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_GrepASandboxFilesystemSecurityRequirements,
                operationName: "GrepASandboxFilesystemAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::LangSmith.PathBuilder(
                                path: $"/api/v2/sandboxes/{sandboxId}/grep",
                                baseUri: ResolveBaseUri(
                                servers: s_GrepASandboxFilesystemServers,
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareGrepASandboxFilesystemRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::LangSmith.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::LangSmith.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "GrepASandboxFilesystem",
                                methodName: "GrepASandboxFilesystemAsync",
                                pathTemplate: "$\"/api/v2/sandboxes/{sandboxId}/grep\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessGrepASandboxFilesystemResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::LangSmith.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessGrepASandboxFilesystemResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::LangSmith.SandboxesGrepResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::LangSmith.AutoSDKHttpResponse<global::LangSmith.SandboxesGrepResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::LangSmith.SandboxesGrepResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::LangSmith.SandboxesGrepResponse> GrepASandboxFilesystemAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::LangSmith.SandboxesGrepRequest
            {
                Glob = glob,
                Limit = limit,
                Path = path,
            ...
            return await GrepASandboxFilesystemAsync(
                sandboxId: sandboxId,
                request: __request,
                requestOptions: requestOptions,
