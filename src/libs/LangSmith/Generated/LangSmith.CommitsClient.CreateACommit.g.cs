            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            if ((int)__response.StatusCode == 400)
            {
                ...
                try
                {
                    if (ReadResponseAsString)
                    {
                        ...
                        __value_400 = global::LangSmith.CommitsErrorResponse.FromJson(__content_400, JsonSerializerOptions);
                    }
                    else
                    {
                        __content_400 = await __response.Content.ReadAsStringAsync(cancellationToken).ConfigureAwait(false);
            ...
            if ((int)__response.StatusCode == 403)
            {
                ...
                try
                {
                    if (ReadResponseAsString)
                    {
                        ...
                        __value_403 = global::LangSmith.CommitsErrorResponse.FromJson(__content_403, JsonSerializerOptions);
                    }
                    else
                    {
                        __content_403 = await __response.Content.ReadAsStringAsync(cancellationToken).ConfigureAwait(false);
            ...
            if ((int)__response.StatusCode == 404)
            {
                ...
                try
                {
                    if (ReadResponseAsString)
                    {
                        ...
                        __value_404 = global::LangSmith.CommitsErrorResponse.FromJson(__content_404, JsonSerializerOptions);
                    }
                    else
                    {
                        __content_404 = await __response.Content.ReadAsStringAsync(cancellationToken).ConfigureAwait(false);
            ...
            if ((int)__response.StatusCode == 500)
            {
                ...
                try
                {
                    if (ReadResponseAsString)
                    {
                        ...
                        __value_500 = global::LangSmith.CommitsErrorResponse.FromJson(__content_500, JsonSerializerOptions);
                    }
                    else
                    {
                        __content_500 = await __response.Content.ReadAsStringAsync(cancellationToken).ConfigureAwait(false);
            ...
            if (ReadResponseAsString)
            {
                ...
                try
                {
                    ...
                    return
                        global::LangSmith.CommitsCreateCommitResponse.FromJson(__content, JsonSerializerOptions) ??
            ...
            else
            {
                try
                {
                    ...
                    return
                        await global::LangSmith.CommitsCreateCommitResponse.FromJsonStreamAsync(__content, JsonSerializerOptions).ConfigureAwait(false) ??
