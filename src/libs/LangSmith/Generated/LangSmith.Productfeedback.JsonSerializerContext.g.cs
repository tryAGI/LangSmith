...
namespace LangSmith
{
    ...
    public sealed partial class ProductfeedbackSourceGenerationContext : global::System.Text.Json.Serialization.JsonSerializerContext
    {
        ...
        ///
        /// </summary>
        public static ProductfeedbackSourceGenerationContext Default { get; } = new(DefaultOptions);

        private ProductfeedbackSourceGenerationContext(global::System.Text.Json.JsonSerializerOptions options)
            : base(options)
        {
        }
