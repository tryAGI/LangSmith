...
namespace LangSmith
{
    public partial class SandboxesClient
    {
        ...
        private static readonly global::LangSmith.AutoSDKServer[] s_DownloadASandboxFile2Servers = new global::LangSmith.AutoSDKServer[]
        ...
        private static readonly global::LangSmith.EndPointSecurityRequirement s_DownloadASandboxFile2SecurityRequirement0 =
        ...
        private static readonly global::LangSmith.EndPointSecurityRequirement[] s_DownloadASandboxFile2SecurityRequirements =
            new global::LangSmith.EndPointSecurityRequirement[]
            {                s_DownloadASandboxFile2SecurityRequirement0,
            };
        partial void PrepareDownloadASandboxFile2Arguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string sandboxId,
            ref string path,
            ref string? range);
        partial void PrepareDownloadASandboxFile2Request(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string sandboxId,
            string path,
            string? range);
        partial void ProcessDownloadASandboxFile2Response(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessDownloadASandboxFile2ResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref byte[] content);
        ...
        public async global::System.Threading.Tasks.Task<byte[]> DownloadASandboxFile2Async(
            string sandboxId,
            string path,
        ...
        {
            var __response = await DownloadASandboxFile2AsResponseAsync(
                sandboxId: sandboxId,
                path: path,
                range: range,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::LangSmith.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::System.IO.Stream> DownloadASandboxFile2AsStreamAsync(
            string sandboxId,
            string path,
            string? range = default,
            global::LangSmith.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareDownloadASandboxFile2Arguments(
            ...
            var __authorizations = global::LangSmith.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_DownloadASandboxFile2SecurityRequirements,
                operationName: "DownloadASandboxFile2Async");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::LangSmith.PathBuilder(
                                path: $"/api/v2/sandboxes/{sandboxId}/download",
                                baseUri: ResolveBaseUri(
                                servers: s_DownloadASandboxFile2Servers,
            ...
            if (range != default)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareDownloadASandboxFile2Request(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::LangSmith.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::LangSmith.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "DownloadASandboxFile2",
                                methodName: "DownloadASandboxFile2Async",
                                pathTemplate: "$\"/api/v2/sandboxes/{sandboxId}/download\"",
                                httpMethod: "HEAD",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessDownloadASandboxFile2Response(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::LangSmith.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if ((int)__response.StatusCode == 416)
                            {
                                ...
                                string? __value_416 = null;
                                try
                                {
                                    if (__effectiveReadResponseAsString)
                                    {
                                        __content_416 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                        __value_416 = (string?)global::System.Text.Json.JsonSerializer.Deserialize(__content_416, typeof(string), JsonSerializerContext);
                                    }
                                    else
                                    {
                                        __content_416 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                            ...
                            try
                            {
                                ...
                                return new global::LangSmith.ResponseStream(__response, __content);
                            }
                            catch (global::System.Exception __ex)
                            {
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::LangSmith.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::LangSmith.AutoSDKHttpResponse<byte[]>> DownloadASandboxFile2AsResponseAsync(
            string sandboxId,
            string path,
            string? range = default,
            global::LangSmith.AutoSDKRequestOptions? requestOptions = default,
                ...
                else
                {
                    await global::LangSmith.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessDownloadASandboxFile2ResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                ...
                                try
                                {
                                    ...
                                    return new global::LangSmith.AutoSDKHttpResponse<byte[]>(
                                        statusCode: __response.StatusCode,
