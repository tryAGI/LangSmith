...
namespace LangSmith
{
    public partial class AccessPoliciesClient
    {
        ...
        private static readonly global::LangSmith.AutoSDKServer[] s_CreateAnAccessPolicyServers = new global::LangSmith.AutoSDKServer[]
        ...
        private static readonly global::LangSmith.EndPointSecurityRequirement s_CreateAnAccessPolicySecurityRequirement0 =
        ...
        private static readonly global::LangSmith.EndPointSecurityRequirement[] s_CreateAnAccessPolicySecurityRequirements =
            new global::LangSmith.EndPointSecurityRequirement[]
            {                s_CreateAnAccessPolicySecurityRequirement0,
            };
        ...
        {
            var __response = await CreateAnAccessPolicyAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::LangSmith.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::LangSmith.AutoSDKHttpResponse<global::LangSmith.AuthzInternalAccessPolicyCreateResponse>> CreateAnAccessPolicyAsResponseAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var __authorizations = global::LangSmith.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_CreateAnAccessPolicySecurityRequirements,
                operationName: "CreateAnAccessPolicyAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::LangSmith.PathBuilder(
                                ...
                                servers: s_CreateAnAccessPolicyServers,
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::LangSmith.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::LangSmith.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "CreateAnAccessPolicy",
                                methodName: "CreateAnAccessPolicyAsync",
                    ...
                    await global::LangSmith.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if ((int)__response.StatusCode == 400)
                            {
                                ...
                                try
                                {
                                    if (__effectiveReadResponseAsString)
                                    {
                                        ...
                                        __value_400 = global::LangSmith.AbacErrorResponse.FromJson(__content_400, JsonSerializerContext);
                                    }
                                    else
                                    {
                                        __content_400 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                            ...
                            if ((int)__response.StatusCode == 404)
                            {
                                ...
                                try
                                {
                                    if (__effectiveReadResponseAsString)
                                    {
                                        ...
                                        __value_404 = global::LangSmith.AbacErrorResponse.FromJson(__content_404, JsonSerializerContext);
                                    }
                                    else
                                    {
                                        __content_404 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    var __value = global::LangSmith.AuthzInternalAccessPolicyCreateResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::LangSmith.AutoSDKHttpResponse<global::LangSmith.AuthzInternalAccessPolicyCreateResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::LangSmith.AuthzInternalAccessPolicyCreateResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
