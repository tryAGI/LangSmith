...
namespace LangSmith
{
    public partial class RunsClient
    {
        ...
        private static readonly global::LangSmith.AutoSDKServer[] s_GetTheLangSmithUiUrlForARunServers = new global::LangSmith.AutoSDKServer[]
        ...
        private static readonly global::LangSmith.EndPointSecurityRequirement s_GetTheLangSmithUiUrlForARunSecurityRequirement0 =
        ...
        private static readonly global::LangSmith.EndPointSecurityRequirement[] s_GetTheLangSmithUiUrlForARunSecurityRequirements =
            new global::LangSmith.EndPointSecurityRequirement[]
            {                s_GetTheLangSmithUiUrlForARunSecurityRequirement0,
            };
        partial void PrepareGetTheLangSmithUiUrlForARunArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref global::System.Guid runId,
            ref string projectId,
            ref string traceId,
            ref string? startTime);
        partial void PrepareGetTheLangSmithUiUrlForARunRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            string traceId,
            string? startTime);
        partial void ProcessGetTheLangSmithUiUrlForARunResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessGetTheLangSmithUiUrlForARunResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        /// run's project_id and trace_id as query parameters; start_time is optional.<br/>
        ...
        public async global::System.Threading.Tasks.Task<global::LangSmith.QueryRunURLResponse> GetTheLangSmithUiUrlForARunAsync(
            global::System.Guid runId,
            string projectId,
            string traceId,
        ...
        {
            var __response = await GetTheLangSmithUiUrlForARunAsResponseAsync(
                runId: runId,
                projectId: projectId,
                traceId: traceId,
                startTime: startTime,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::LangSmith.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::LangSmith.AutoSDKHttpResponse<global::LangSmith.QueryRunURLResponse>> GetTheLangSmithUiUrlForARunAsResponseAsync(
            global::System.Guid runId,
            string projectId,
            string traceId,
            string? startTime = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareGetTheLangSmithUiUrlForARunArguments(
            ...
            var __authorizations = global::LangSmith.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_GetTheLangSmithUiUrlForARunSecurityRequirements,
                operationName: "GetTheLangSmithUiUrlForARunAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::LangSmith.PathBuilder(
                                path: $"/api/v2/runs/{runId}/url",
                                baseUri: ResolveBaseUri(
                                servers: s_GetTheLangSmithUiUrlForARunServers,
                                defaultBaseUrl: "https://api.smith.langchain.com/"));
                            __pathBuilder
                                .AddRequiredParameter("project_id", projectId)
                                .AddRequiredParameter("trace_id", traceId)
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareGetTheLangSmithUiUrlForARunRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::LangSmith.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::LangSmith.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "GetTheLangSmithUiUrlForARun",
                                methodName: "GetTheLangSmithUiUrlForARunAsync",
                                pathTemplate: "$\"/api/v2/runs/{runId}/url\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessGetTheLangSmithUiUrlForARunResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::LangSmith.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessGetTheLangSmithUiUrlForARunResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::LangSmith.QueryRunURLResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::LangSmith.AutoSDKHttpResponse<global::LangSmith.QueryRunURLResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::LangSmith.QueryRunURLResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
