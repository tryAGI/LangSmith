...
namespace LangSmith
{
    public partial class FleetUsageClient
    {
        ...
        private static readonly global::LangSmith.AutoSDKServer[] s_ListFleetAgentsWithUsageServers = new global::LangSmith.AutoSDKServer[]
        ...
        partial void PrepareListFleetAgentsWithUsageRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            string? sortBy,
            string? sortOrder);
        partial void ProcessListFleetAgentsWithUsageResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessListFleetAgentsWithUsageResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::LangSmith.UsageAgentUsageResponse> ListFleetAgentsWithUsageAsync(
            string startTime,
            string endTime,
            int? limit = default,
        ...
        {
            var __response = await ListFleetAgentsWithUsageAsResponseAsync(
                startTime: startTime,
                endTime: endTime,
                limit: limit,
                sortBy: sortBy,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::LangSmith.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::LangSmith.AutoSDKHttpResponse<global::LangSmith.UsageAgentUsageResponse>> ListFleetAgentsWithUsageAsResponseAsync(
            string startTime,
            string endTime,
            int? limit = default,
            string? sortBy = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareListFleetAgentsWithUsageArguments(
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::LangSmith.PathBuilder(
                                ...
                                servers: s_ListFleetAgentsWithUsageServers,
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareListFleetAgentsWithUsageRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::LangSmith.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::LangSmith.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "ListFleetAgentsWithUsage",
                                methodName: "ListFleetAgentsWithUsageAsync",
                                pathTemplate: "\"/v1/platform/fleet/usage/agents\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessListFleetAgentsWithUsageResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::LangSmith.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessListFleetAgentsWithUsageResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::LangSmith.UsageAgentUsageResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::LangSmith.AutoSDKHttpResponse<global::LangSmith.UsageAgentUsageResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::LangSmith.UsageAgentUsageResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
