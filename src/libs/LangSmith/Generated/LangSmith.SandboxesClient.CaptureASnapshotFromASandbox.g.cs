...
namespace LangSmith
{
    public partial class SandboxesClient
    {
        ...
        private static readonly global::LangSmith.EndPointSecurityRequirement[] s_CaptureASnapshotFromASandboxSecurityRequirements =
            new global::LangSmith.EndPointSecurityRequirement[]
            {                s_CaptureASnapshotFromASandboxSecurityRequirement0,
            };
        ...
        partial void ProcessCaptureASnapshotFromASandboxResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        {
            var __response = await CaptureASnapshotFromASandboxAsResponseAsync(
                name: name,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::LangSmith.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::LangSmith.AutoSDKHttpResponse<global::LangSmith.SandboxesSnapshotResponse>> CaptureASnapshotFromASandboxAsResponseAsync(
            string name,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var __authorizations = global::LangSmith.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_CaptureASnapshotFromASandboxSecurityRequirements,
                operationName: "CaptureASnapshotFromASandboxAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::LangSmith.PathBuilder(
                                path: $"/api/v2/sandboxes/boxes/{name}/snapshot",
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::LangSmith.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::LangSmith.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                pathTemplate: "$\"/api/v2/sandboxes/boxes/{name}/snapshot\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessCaptureASnapshotFromASandboxResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::LangSmith.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            // sandbox must be running for Docker image export
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessCaptureASnapshotFromASandboxResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
