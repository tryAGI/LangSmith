...
{
    /// <summary>
    /// Query params for run stats on a shared dataset.
    /// </summary>
    public sealed partial class RunStatsQueryParamsPublic
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="RunStatsQueryParamsPublic" /> class.
        /// </summary>
        /// <param name="id"></param>
        /// <param name="trace">
        /// Filter runs by trace ID. When set, limit and cursor-based pagination are not applied — all runs in the trace are returned in a single response.
...
#endif
        public RunStatsQueryParamsPublic(
