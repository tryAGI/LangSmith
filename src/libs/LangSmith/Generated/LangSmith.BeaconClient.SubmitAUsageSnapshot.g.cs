...
namespace LangSmith
{
    public partial class BeaconClient
    {
        ...
        private static readonly global::LangSmith.AutoSDKServer[] s_SubmitAUsageSnapshotServers = new global::LangSmith.AutoSDKServer[]
        ...
        private static readonly global::LangSmith.EndPointSecurityRequirement s_SubmitAUsageSnapshotSecurityRequirement0 =
        ...
        private static readonly global::LangSmith.EndPointSecurityRequirement[] s_SubmitAUsageSnapshotSecurityRequirements =
            new global::LangSmith.EndPointSecurityRequirement[]
            {                s_SubmitAUsageSnapshotSecurityRequirement0,
            };
        partial void PrepareSubmitAUsageSnapshotArguments(
            global::System.Net.Http.HttpClient httpClient,
            global::LangSmith.BeaconSubmitUsageSnapshotPayload request);
        partial void PrepareSubmitAUsageSnapshotRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            global::LangSmith.BeaconSubmitUsageSnapshotPayload request);
        partial void ProcessSubmitAUsageSnapshotResponse(
            global::System.Net.Http.HttpClient httpClient,
        ...
        public async global::System.Threading.Tasks.Task SubmitAUsageSnapshotAsync(

            global::LangSmith.BeaconSubmitUsageSnapshotPayload request,
            global::LangSmith.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            await SubmitAUsageSnapshotAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::LangSmith.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::LangSmith.AutoSDKHttpResponse> SubmitAUsageSnapshotAsResponseAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareSubmitAUsageSnapshotArguments(
            ...
            var __authorizations = global::LangSmith.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_SubmitAUsageSnapshotSecurityRequirements,
                operationName: "SubmitAUsageSnapshotAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::LangSmith.PathBuilder(
                                ...
                                servers: s_SubmitAUsageSnapshotServers,
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareSubmitAUsageSnapshotRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::LangSmith.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::LangSmith.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "SubmitAUsageSnapshot",
                                methodName: "SubmitAUsageSnapshotAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessSubmitAUsageSnapshotResponse(
                    httpClient: HttpClient,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            await SubmitAUsageSnapshotAsync(
                request: __request,
                requestOptions: requestOptions,
