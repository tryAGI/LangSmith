...
namespace LangSmith
{
    public partial class FleetAuthClient
    {
        ...
        private static readonly global::LangSmith.AutoSDKServer[] s_GetAnAuthorizationSessionServers = new global::LangSmith.AutoSDKServer[]
        ...
        private static readonly global::LangSmith.EndPointSecurityRequirement s_GetAnAuthorizationSessionSecurityRequirement0 =
        ...
        private static readonly global::LangSmith.EndPointSecurityRequirement[] s_GetAnAuthorizationSessionSecurityRequirements =
            new global::LangSmith.EndPointSecurityRequirement[]
            {                s_GetAnAuthorizationSessionSecurityRequirement0,
            };
        partial void PrepareGetAnAuthorizationSessionArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string sessionId,
            ref int? waitSeconds);
        partial void PrepareGetAnAuthorizationSessionRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string sessionId,
            int? waitSeconds);
        partial void ProcessGetAnAuthorizationSessionResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessGetAnAuthorizationSessionResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::LangSmith.AuthGetSessionResponse> GetAnAuthorizationSessionAsync(
            string sessionId,
            int? waitSeconds = default,
            global::LangSmith.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await GetAnAuthorizationSessionAsResponseAsync(
                sessionId: sessionId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::LangSmith.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::LangSmith.AutoSDKHttpResponse<global::LangSmith.AuthGetSessionResponse>> GetAnAuthorizationSessionAsResponseAsync(
            string sessionId,
            int? waitSeconds = default,
            global::LangSmith.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareGetAnAuthorizationSessionArguments(
            ...
            var __authorizations = global::LangSmith.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_GetAnAuthorizationSessionSecurityRequirements,
                operationName: "GetAnAuthorizationSessionAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::LangSmith.PathBuilder(
                                path: $"/v1/fleet/auth-sessions/{sessionId}",
                                baseUri: ResolveBaseUri(
                                servers: s_GetAnAuthorizationSessionServers,
                                defaultBaseUrl: "https://api.smith.langchain.com/"));
                            __pathBuilder
                                .AddOptionalParameter("wait_seconds", waitSeconds?.ToString())
                                ;
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareGetAnAuthorizationSessionRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::LangSmith.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::LangSmith.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "GetAnAuthorizationSession",
                                methodName: "GetAnAuthorizationSessionAsync",
                                pathTemplate: "$\"/v1/fleet/auth-sessions/{sessionId}\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessGetAnAuthorizationSessionResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::LangSmith.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessGetAnAuthorizationSessionResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::LangSmith.AuthGetSessionResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::LangSmith.AutoSDKHttpResponse<global::LangSmith.AuthGetSessionResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::LangSmith.AuthGetSessionResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
