...
namespace LangSmith
{
    public partial class DatasetsClient
    {
        ...
        private static readonly global::LangSmith.AutoSDKServer[] s_ReadDeltaStreamServers = new global::LangSmith.AutoSDKServer[]
        ...
        private static readonly global::LangSmith.EndPointSecurityRequirement s_ReadDeltaStreamSecurityRequirement0 =
        ...
        private static readonly global::LangSmith.EndPointSecurityRequirement[] s_ReadDeltaStreamSecurityRequirements =
            new global::LangSmith.EndPointSecurityRequirement[]
            {                s_ReadDeltaStreamSecurityRequirement0,
            };
        partial void PrepareReadDeltaStreamArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref global::System.Guid datasetId,
            global::LangSmith.QueryFeedbackDeltaBatch request);
        partial void PrepareReadDeltaStreamRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            global::System.Guid datasetId,
            global::LangSmith.QueryFeedbackDeltaBatch request);
        partial void ProcessReadDeltaStreamResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessReadDeltaStreamResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        {
            var __response = await ReadDeltaStreamAsResponseAsync(
                datasetId: datasetId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::LangSmith.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::LangSmith.AutoSDKHttpResponse<string>> ReadDeltaStreamAsResponseAsync(
            global::System.Guid datasetId,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareReadDeltaStreamArguments(
            ...
            var __authorizations = global::LangSmith.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_ReadDeltaStreamSecurityRequirements,
                operationName: "ReadDeltaStreamAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::LangSmith.PathBuilder(
                                path: $"/api/v1/datasets/{datasetId}/runs/delta/stream",
                                baseUri: ResolveBaseUri(
                                servers: s_ReadDeltaStreamServers,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::LangSmith.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::LangSmith.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "ReadDeltaStream",
                                methodName: "ReadDeltaStreamAsync",
                                pathTemplate: "$\"/api/v1/datasets/{datasetId}/runs/delta/stream\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessReadDeltaStreamResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::LangSmith.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessReadDeltaStreamResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            return await ReadDeltaStreamAsync(
                datasetId: datasetId,
                request: __request,
                requestOptions: requestOptions,
