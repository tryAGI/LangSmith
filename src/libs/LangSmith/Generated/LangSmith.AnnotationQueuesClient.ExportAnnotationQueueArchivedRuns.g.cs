...
namespace LangSmith
{
    public partial class AnnotationQueuesClient
    {
        ...
        private static readonly global::LangSmith.AutoSDKServer[] s_ExportAnnotationQueueArchivedRunsServers = new global::LangSmith.AutoSDKServer[]
        ...
        private static readonly global::LangSmith.EndPointSecurityRequirement s_ExportAnnotationQueueArchivedRunsSecurityRequirement0 =
        ...
        private static readonly global::LangSmith.EndPointSecurityRequirement[] s_ExportAnnotationQueueArchivedRunsSecurityRequirements =
            new global::LangSmith.EndPointSecurityRequirement[]
        ...
        partial void PrepareExportAnnotationQueueArchivedRunsRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            global::System.Guid queueId,
            global::LangSmith.ExportAnnotationQueueRunsRequest request);
        partial void ProcessExportAnnotationQueueArchivedRunsResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessExportAnnotationQueueArchivedRunsResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        {
            var __response = await ExportAnnotationQueueArchivedRunsAsResponseAsync(
                queueId: queueId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::LangSmith.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::LangSmith.AutoSDKHttpResponse<string>> ExportAnnotationQueueArchivedRunsAsResponseAsync(
            global::System.Guid queueId,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareExportAnnotationQueueArchivedRunsArguments(
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::LangSmith.PathBuilder(
                                ...
                                servers: s_ExportAnnotationQueueArchivedRunsServers,
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareExportAnnotationQueueArchivedRunsRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::LangSmith.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::LangSmith.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "ExportAnnotationQueueArchivedRuns",
                                methodName: "ExportAnnotationQueueArchivedRunsAsync",
                                pathTemplate: "$\"/api/v1/annotation-queues/{queueId}/export\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessExportAnnotationQueueArchivedRunsResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::LangSmith.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessExportAnnotationQueueArchivedRunsResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            return await ExportAnnotationQueueArchivedRunsAsync(
                queueId: queueId,
                request: __request,
                requestOptions: requestOptions,
