...
namespace LangSmith
{
    public partial class OauthClient
    {
        ...
        private static readonly global::LangSmith.AutoSDKServer[] s_InitiateOAuth2AuthorizationServers = new global::LangSmith.AutoSDKServer[]
        ...
        private static readonly global::LangSmith.EndPointSecurityRequirement s_InitiateOAuth2AuthorizationSecurityRequirement0 =
        ...
        private static readonly global::LangSmith.EndPointSecurityRequirement[] s_InitiateOAuth2AuthorizationSecurityRequirements =
            new global::LangSmith.EndPointSecurityRequirement[]
            {                s_InitiateOAuth2AuthorizationSecurityRequirement0,
            };
        partial void PrepareInitiateOAuth2AuthorizationArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string responseType,
            ref string clientId,
            ref string redirectUri,
            ref string codeChallenge,
            ref string codeChallengeMethod,
            ref string? state);
        partial void PrepareInitiateOAuth2AuthorizationRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            string? state);
        partial void ProcessInitiateOAuth2AuthorizationResponse(
            global::System.Net.Http.HttpClient httpClient,
        ...
        public async global::System.Threading.Tasks.Task InitiateOAuth2AuthorizationAsync(
            string responseType,
            string clientId,
            string redirectUri,
            string codeChallenge,
        ...
        {
            await InitiateOAuth2AuthorizationAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::LangSmith.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::LangSmith.AutoSDKHttpResponse> InitiateOAuth2AuthorizationAsResponseAsync(
            string responseType,
            string clientId,
            string redirectUri,
            string codeChallenge,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareInitiateOAuth2AuthorizationArguments(
            ...
            var __authorizations = global::LangSmith.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_InitiateOAuth2AuthorizationSecurityRequirements,
                operationName: "InitiateOAuth2AuthorizationAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::LangSmith.PathBuilder(
                                ...
                                servers: s_InitiateOAuth2AuthorizationServers,
                                defaultBaseUrl: "https://api.smith.langchain.com/"));
                            __pathBuilder
                                .AddRequiredParameter("response_type", responseType)
                                .AddRequiredParameter("client_id", clientId)
                                .AddRequiredParameter("redirect_uri", redirectUri)
                                .AddRequiredParameter("code_challenge", codeChallenge)
                                .AddRequiredParameter("code_challenge_method", codeChallengeMethod)
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::LangSmith.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::LangSmith.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "InitiateOAuth2Authorization",
                                methodName: "InitiateOAuth2AuthorizationAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessInitiateOAuth2AuthorizationResponse(
                    httpClient: HttpClient,
