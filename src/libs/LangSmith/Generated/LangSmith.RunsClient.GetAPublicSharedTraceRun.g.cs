...
namespace LangSmith
{
    public partial class RunsClient
    {
        ...
        private static readonly global::LangSmith.AutoSDKServer[] s_GetAPublicSharedTraceRunServers = new global::LangSmith.AutoSDKServer[]
        ...
        private static readonly global::LangSmith.EndPointSecurityRequirement s_GetAPublicSharedTraceRunSecurityRequirement0 =
        ...
        private static readonly global::LangSmith.EndPointSecurityRequirement[] s_GetAPublicSharedTraceRunSecurityRequirements =
            new global::LangSmith.EndPointSecurityRequirement[]
            {                s_GetAPublicSharedTraceRunSecurityRequirement0,
            };
        partial void PrepareGetAPublicSharedTraceRunArguments(
        ...
        partial void PrepareGetAPublicSharedTraceRunRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            global::System.Collections.Generic.IList<string> selects);
        partial void ProcessGetAPublicSharedTraceRunResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessGetAPublicSharedTraceRunResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        /// Returns one run within the trace identified by the share token. The request supplies only the run ID and that run's exact start_time coordinate.<br/>
        ...
        public async global::System.Threading.Tasks.Task<global::LangSmith.QueryRunResponse> GetAPublicSharedTraceRunAsync(
            global::System.Guid shareToken,
            global::System.Guid runId,
            global::System.DateTime startTime,
            global::System.Collections.Generic.IList<string> selects,
        ...
        {
            var __response = await GetAPublicSharedTraceRunAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::LangSmith.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::LangSmith.AutoSDKHttpResponse<global::LangSmith.QueryRunResponse>> GetAPublicSharedTraceRunAsResponseAsync(
            global::System.Guid shareToken,
            global::System.Guid runId,
            global::System.DateTime startTime,
            global::System.Collections.Generic.IList<string> selects,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareGetAPublicSharedTraceRunArguments(
            ...
            var __authorizations = global::LangSmith.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_GetAPublicSharedTraceRunSecurityRequirements,
                operationName: "GetAPublicSharedTraceRunAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::LangSmith.PathBuilder(
                                path: $"/api/v2/public/{shareToken}/run/{runId}",
                                baseUri: ResolveBaseUri(
                                servers: s_GetAPublicSharedTraceRunServers,
            ...
            if (accept != default)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareGetAPublicSharedTraceRunRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::LangSmith.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::LangSmith.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "GetAPublicSharedTraceRun",
                                methodName: "GetAPublicSharedTraceRunAsync",
                                pathTemplate: "$\"/api/v2/public/{shareToken}/run/{runId}\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessGetAPublicSharedTraceRunResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::LangSmith.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            // bad request (missing or malformed start_time)
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessGetAPublicSharedTraceRunResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::LangSmith.QueryRunResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::LangSmith.AutoSDKHttpResponse<global::LangSmith.QueryRunResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::LangSmith.QueryRunResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
