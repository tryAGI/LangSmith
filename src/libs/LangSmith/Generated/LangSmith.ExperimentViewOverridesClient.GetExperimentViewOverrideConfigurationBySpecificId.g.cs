            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            if ((int)__response.StatusCode == 401)
            {
                ...
                try
                {
                    if (ReadResponseAsString)
                    {
                        ...
                        __value_401 = global::System.Text.Json.JsonSerializer.Deserialize<global::System.Collections.Generic.Dictionary<string, string>?>(__content_401, JsonSerializerOptions);
                    }
                    else
                    {
                        __content_401 = await __response.Content.ReadAsStringAsync(cancellationToken).ConfigureAwait(false);
            ...
            if (ReadResponseAsString)
            {
                ...
                try
                {
                    ...
                    return
                        global::LangSmith.ExperimentViewOverridesExperimentViewOverride.FromJson(__content, JsonSerializerOptions) ??
            ...
            else
            {
                try
                {
                    ...
                    return
                        await global::LangSmith.ExperimentViewOverridesExperimentViewOverride.FromJsonStreamAsync(__content, JsonSerializerOptions).ConfigureAwait(false) ??
