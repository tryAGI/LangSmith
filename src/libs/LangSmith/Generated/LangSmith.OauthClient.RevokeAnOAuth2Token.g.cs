...
namespace LangSmith
{
    public partial class OauthClient
    {
        ...
        private static readonly global::LangSmith.AutoSDKServer[] s_RevokeAnOAuth2TokenServers = new global::LangSmith.AutoSDKServer[]
        ...
        private static readonly global::LangSmith.EndPointSecurityRequirement s_RevokeAnOAuth2TokenSecurityRequirement0 =
        ...
        private static readonly global::LangSmith.EndPointSecurityRequirement[] s_RevokeAnOAuth2TokenSecurityRequirements =
            new global::LangSmith.EndPointSecurityRequirement[]
            {                s_RevokeAnOAuth2TokenSecurityRequirement0,
            };
        partial void PrepareRevokeAnOAuth2TokenArguments(
            global::System.Net.Http.HttpClient httpClient,
            global::LangSmith.CreateOauthRevokeRequest request);
        partial void PrepareRevokeAnOAuth2TokenRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            global::LangSmith.CreateOauthRevokeRequest request);
        partial void ProcessRevokeAnOAuth2TokenResponse(
            global::System.Net.Http.HttpClient httpClient,
        ...
        public async global::System.Threading.Tasks.Task RevokeAnOAuth2TokenAsync(

            global::LangSmith.CreateOauthRevokeRequest request,
            global::LangSmith.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            await RevokeAnOAuth2TokenAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::LangSmith.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::LangSmith.AutoSDKHttpResponse> RevokeAnOAuth2TokenAsResponseAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareRevokeAnOAuth2TokenArguments(
            ...
            var __authorizations = global::LangSmith.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_RevokeAnOAuth2TokenSecurityRequirements,
                operationName: "RevokeAnOAuth2TokenAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::LangSmith.PathBuilder(
                                ...
                                servers: s_RevokeAnOAuth2TokenServers,
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareRevokeAnOAuth2TokenRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::LangSmith.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::LangSmith.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "RevokeAnOAuth2Token",
                                methodName: "RevokeAnOAuth2TokenAsync",
                                pathTemplate: "\"/oauth/revoke\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessRevokeAnOAuth2TokenResponse(
                    httpClient: HttpClient,
        ...
        public async global::System.Threading.Tasks.Task RevokeAnOAuth2TokenAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::LangSmith.CreateOauthRevokeRequest
            {
                Token = token,
            };

            await RevokeAnOAuth2TokenAsync(
                request: __request,
                requestOptions: requestOptions,
