...
namespace LangSmith
{
    ...
    public sealed class AutoSDKClientOptions
    {
        ...
        /// </summary>
        public global::LangSmith.AutoSDKRetryOptions Retry { get; set; } = new global::LangSmith.AutoSDKRetryOptions();
        ...
        /// </summary>
        public global::System.Collections.Generic.List<global::LangSmith.IAutoSDKHook> Hooks { get; } =
            new global::System.Collections.Generic.List<global::LangSmith.IAutoSDKHook>();
        ...
        public global::LangSmith.AutoSDKClientOptions AddHook(
            global::LangSmith.IAutoSDKHook hook)
        {
        ...
        /// </summary>
        public global::LangSmith.IAutoSDKAuthorizationProvider? AuthorizationProvider { get; set; }
        ...
        public global::LangSmith.AutoSDKClientOptions UseAuthorizationProvider(
            global::LangSmith.IAutoSDKAuthorizationProvider provider)
        {
            AuthorizationProvider = provider ?? throw new global::System.ArgumentNullException(nameof(provider));
            if (Hooks.Find(static x => x is global::LangSmith.AutoSDKAuthorizationProviderHook) == null)
            {
                Hooks.Add(new global::LangSmith.AutoSDKAuthorizationProviderHook());
            }
    ...
    public readonly struct AutoSDKAuthorizationValue
    {
        ...
        public static global::LangSmith.AutoSDKAuthorizationValue Bearer(string token) => new(value: token, scheme: "Bearer");

        /// <summary>Convenience factory for an API-key header.</summary>
        public static global::LangSmith.AutoSDKAuthorizationValue ApiKeyHeader(string name, string value) =>
    ...
    public interface IAutoSDKAuthorizationProvider
    {
        ...
        global::System.Threading.Tasks.Task<global::System.Collections.Generic.IReadOnlyList<global::LangSmith.AutoSDKAuthorizationValue>?> ResolveAsync(
            global::LangSmith.AutoSDKHookContext context);
    }
...
#pragma warning restore CS0618
    ...
    /// </summary>
    public sealed class AutoSDKAuthorizationProviderHook : global::LangSmith.AutoSDKHook
    {
        /// <inheritdoc />
            ...
            global::LangSmith.AutoSDKHookContext context)
        {
            ...
            if (perRequest != null && perRequest.Count > 0)
            {
                ...
                global::LangSmith.AutoSDKHttpRequestOptions.StampAuthorizationOverride(context.Request);
                return;
            }
        ...
        private static void ApplyAuthorization(
            global::System.Net.Http.HttpRequestMessage request,
            global::LangSmith.AutoSDKAuthorizationValue authorization)
        {
    ...
    public sealed class AutoSDKRequestOptions
    {
        ...
        /// </summary>
        public global::LangSmith.AutoSDKRetryOptions? Retry { get; set; }
        ...
        /// </summary>
        public global::System.Collections.Generic.IReadOnlyList<global::LangSmith.AutoSDKAuthorizationValue>? Authorizations { get; set; }
    }
    ...
    /// </summary>
    public abstract class AutoSDKHook : global::LangSmith.IAutoSDKHook
    {
        /// <inheritdoc />
    ...
    public sealed class AutoSDKHookContext
    {
        ...
        /// </summary>
        public global::LangSmith.AutoSDKClientOptions ClientOptions { get; set; } = null!;

        /// <summary>
        /// The per-request runtime options.
        /// </summary>
        public global::LangSmith.AutoSDKRequestOptions? RequestOptions { get; set; }
    ...
    {
        internal static global::LangSmith.AutoSDKHookContext CreateHookContext(
            string operationId,
            string methodName,
            string pathTemplate,
            string httpMethod,
            ...
            global::LangSmith.AutoSDKClientOptions clientOptions,
            global::LangSmith.AutoSDKRequestOptions? requestOptions,
            int attempt,
            int maxAttempts,
            bool willRetry,
        ...
        {
            return new global::LangSmith.AutoSDKHookContext
            {
        ...
        internal static global::System.TimeSpan GetRetryDelay(
            ...
            int attempt)
        {
            var retryOptions = requestOptions?.Retry ?? clientOptions.Retry ?? new global::LangSmith.AutoSDKRetryOptions();
        ...
        private static global::System.TimeSpan ClampRetryDelay(
            global::System.TimeSpan delay,
            global::LangSmith.AutoSDKRetryOptions retryOptions)
        {
        ...
        private static async global::System.Threading.Tasks.Task InvokeHooksAsync(
            global::LangSmith.AutoSDKClientOptions clientOptions,
            global::System.Func<global::LangSmith.IAutoSDKHook, global::LangSmith.AutoSDKHookContext, global::System.Threading.Tasks.Task> callback,
            global::LangSmith.AutoSDKHookContext context)
        {
