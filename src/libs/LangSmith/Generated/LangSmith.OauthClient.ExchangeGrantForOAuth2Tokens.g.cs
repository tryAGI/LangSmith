...
namespace LangSmith
{
    public partial class OauthClient
    {
        ...
        private static readonly global::LangSmith.AutoSDKServer[] s_ExchangeGrantForOAuth2TokensServers = new global::LangSmith.AutoSDKServer[]
        ...
        private static readonly global::LangSmith.EndPointSecurityRequirement s_ExchangeGrantForOAuth2TokensSecurityRequirement0 =
        ...
        private static readonly global::LangSmith.EndPointSecurityRequirement[] s_ExchangeGrantForOAuth2TokensSecurityRequirements =
            new global::LangSmith.EndPointSecurityRequirement[]
            {                s_ExchangeGrantForOAuth2TokensSecurityRequirement0,
            };
        partial void PrepareExchangeGrantForOAuth2TokensArguments(
            global::System.Net.Http.HttpClient httpClient,
            global::LangSmith.CreateOauthTokenRequest request);
        partial void PrepareExchangeGrantForOAuth2TokensRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            global::LangSmith.CreateOauthTokenRequest request);
        partial void ProcessExchangeGrantForOAuth2TokensResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessExchangeGrantForOAuth2TokensResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::LangSmith.OauthTokenResponse> ExchangeGrantForOAuth2TokensAsync(

            global::LangSmith.CreateOauthTokenRequest request,
            global::LangSmith.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await ExchangeGrantForOAuth2TokensAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::LangSmith.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::LangSmith.AutoSDKHttpResponse<global::LangSmith.OauthTokenResponse>> ExchangeGrantForOAuth2TokensAsResponseAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareExchangeGrantForOAuth2TokensArguments(
            ...
            var __authorizations = global::LangSmith.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_ExchangeGrantForOAuth2TokensSecurityRequirements,
                operationName: "ExchangeGrantForOAuth2TokensAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::LangSmith.PathBuilder(
                                ...
                                servers: s_ExchangeGrantForOAuth2TokensServers,
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareExchangeGrantForOAuth2TokensRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::LangSmith.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::LangSmith.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "ExchangeGrantForOAuth2Tokens",
                                methodName: "ExchangeGrantForOAuth2TokensAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessExchangeGrantForOAuth2TokensResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::LangSmith.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessExchangeGrantForOAuth2TokensResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::LangSmith.OauthTokenResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::LangSmith.AutoSDKHttpResponse<global::LangSmith.OauthTokenResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::LangSmith.OauthTokenResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::LangSmith.OauthTokenResponse> ExchangeGrantForOAuth2TokensAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::LangSmith.CreateOauthTokenRequest
            {
                GrantType = grantType,
                ClientId = clientId,
                Code = code,
            ...
            return await ExchangeGrantForOAuth2TokensAsync(
                request: __request,
                requestOptions: requestOptions,
