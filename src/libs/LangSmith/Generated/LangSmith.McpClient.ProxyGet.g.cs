...
namespace LangSmith
{
    public partial class McpClient
    {
        ...
        private static readonly global::LangSmith.AutoSDKServer[] s_ProxyGetServers = new global::LangSmith.AutoSDKServer[]
        ...
        partial void PrepareProxyGetArguments(
            ...
            ref string url,
            ref bool? acceptStream,
            ref int? timeout);
        partial void PrepareProxyGetRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string url,
            bool? acceptStream,
            int? timeout);
        partial void ProcessProxyGetResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessProxyGetResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<string> ProxyGetAsync(
            string url,
        ...
        {
            var __response = await ProxyGetAsResponseAsync(
                url: url,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::LangSmith.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::LangSmith.AutoSDKHttpResponse<string>> ProxyGetAsResponseAsync(
            string url,
            bool? acceptStream = default,
            int? timeout = default,
            global::LangSmith.AutoSDKRequestOptions? requestOptions = default,
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::LangSmith.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::LangSmith.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "ProxyGetAsync",
                                pathTemplate: "\"/api/v1/mcp/proxy\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                else
                {
                    await global::LangSmith.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessProxyGetResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
