            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            if (ReadResponseAsString)
            {
                ...
                try
                {
                    ...
                    return
                        global::LangSmith.TenantUsageLimitInfo.FromJson(__content, JsonSerializerOptions) ??
            ...
            else
            {
                try
                {
                    ...
                    return
                        await global::LangSmith.TenantUsageLimitInfo.FromJsonStreamAsync(__content, JsonSerializerOptions).ConfigureAwait(false) ??
