...
namespace LangSmith
{
    public partial class FeedbackClient
    {
        ...
        partial void PrepareListFeedbackFormulaEpRequest(
            ...
            int? limit,
            int? offset);
        partial void ProcessListFeedbackFormulaEpResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessListFeedbackFormulaEpResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::System.Collections.Generic.IList<global::LangSmith.FeedbackFormula>> ListFeedbackFormulaEpAsync(
        ...
        {
            var __response = await ListFeedbackFormulaEpAsResponseAsync(
                datasetId: datasetId,
                sessionId: sessionId,
                limit: limit,
                offset: offset,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::LangSmith.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::LangSmith.AutoSDKHttpResponse<global::System.Collections.Generic.IList<global::LangSmith.FeedbackFormula>>> ListFeedbackFormulaEpAsResponseAsync(
            global::System.Guid? datasetId = default,
            global::System.Guid? sessionId = default,
            int? limit = default,
            int? offset = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareListFeedbackFormulaEpRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::LangSmith.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::LangSmith.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "ListFeedbackFormulaEp",
                                methodName: "ListFeedbackFormulaEpAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessListFeedbackFormulaEpResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::LangSmith.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessListFeedbackFormulaEpResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = (global::System.Collections.Generic.IList<global::LangSmith.FeedbackFormula>?)global::System.Text.Json.JsonSerializer.Deserialize(__content, typeof(global::System.Collections.Generic.IList<global::LangSmith.FeedbackFormula>), JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::LangSmith.AutoSDKHttpResponse<global::System.Collections.Generic.IList<global::LangSmith.FeedbackFormula>>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = (global::System.Collections.Generic.IList<global::LangSmith.FeedbackFormula>?)await global::System.Text.Json.JsonSerializer.DeserializeAsync(__content, typeof(global::System.Collections.Generic.IList<global::LangSmith.FeedbackFormula>), JsonSerializerContext).ConfigureAwait(false) ??
