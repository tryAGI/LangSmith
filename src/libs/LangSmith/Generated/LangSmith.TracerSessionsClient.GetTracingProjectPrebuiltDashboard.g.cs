...
namespace LangSmith
{
    public partial class TracerSessionsClient
    {
        ...
        private static readonly global::LangSmith.AutoSDKServer[] s_GetTracingProjectPrebuiltDashboardServers = new global::LangSmith.AutoSDKServer[]
        ...
        private static readonly global::LangSmith.EndPointSecurityRequirement s_GetTracingProjectPrebuiltDashboardSecurityRequirement0 =
        ...
        private static readonly global::LangSmith.EndPointSecurityRequirement[] s_GetTracingProjectPrebuiltDashboardSecurityRequirements =
            new global::LangSmith.EndPointSecurityRequirement[]
            {                s_GetTracingProjectPrebuiltDashboardSecurityRequirement0,
            };
        ...
        {
            var __response = await GetTracingProjectPrebuiltDashboardAsResponseAsync(
                sessionId: sessionId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::LangSmith.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::LangSmith.AutoSDKHttpResponse<global::LangSmith.CustomChartsSection>> GetTracingProjectPrebuiltDashboardAsResponseAsync(
            global::System.Guid sessionId,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var __authorizations = global::LangSmith.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_GetTracingProjectPrebuiltDashboardSecurityRequirements,
                operationName: "GetTracingProjectPrebuiltDashboardAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::LangSmith.PathBuilder(
                                ...
                                servers: s_GetTracingProjectPrebuiltDashboardServers,
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::LangSmith.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::LangSmith.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "GetTracingProjectPrebuiltDashboard",
                                methodName: "GetTracingProjectPrebuiltDashboardAsync",
                    ...
                    await global::LangSmith.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    var __value = global::LangSmith.CustomChartsSection.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::LangSmith.AutoSDKHttpResponse<global::LangSmith.CustomChartsSection>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::LangSmith.CustomChartsSection.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
