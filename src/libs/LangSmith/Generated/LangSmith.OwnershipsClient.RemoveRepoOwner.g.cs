...
namespace LangSmith
{
    public partial class OwnershipsClient
    {
        ...
        private static readonly global::LangSmith.AutoSDKServer[] s_RemoveRepoOwnerServers = new global::LangSmith.AutoSDKServer[]
        ...
        private static readonly global::LangSmith.EndPointSecurityRequirement s_RemoveRepoOwnerSecurityRequirement0 =
        ...
        private static readonly global::LangSmith.EndPointSecurityRequirement[] s_RemoveRepoOwnerSecurityRequirements =
            new global::LangSmith.EndPointSecurityRequirement[]
            {                s_RemoveRepoOwnerSecurityRequirement0,
            };
        partial void PrepareRemoveRepoOwnerArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string owner,
            ref string repo,
            global::LangSmith.RemoveRepoOwnerRequest request);
        partial void PrepareRemoveRepoOwnerRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string owner,
            string repo,
            global::LangSmith.RemoveRepoOwnerRequest request);
        partial void ProcessRemoveRepoOwnerResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessRemoveRepoOwnerResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<string> RemoveRepoOwnerAsync(
            string owner,
            string repo,
        ...
        {
            var __response = await RemoveRepoOwnerAsResponseAsync(
                owner: owner,
                repo: repo,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::LangSmith.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::LangSmith.AutoSDKHttpResponse<string>> RemoveRepoOwnerAsResponseAsync(
            string owner,
            string repo,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareRemoveRepoOwnerArguments(
            ...
            var __authorizations = global::LangSmith.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_RemoveRepoOwnerSecurityRequirements,
                operationName: "RemoveRepoOwnerAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::LangSmith.PathBuilder(
                                ...
                                servers: s_RemoveRepoOwnerServers,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::LangSmith.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::LangSmith.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "RemoveRepoOwner",
                                methodName: "RemoveRepoOwnerAsync",
                                pathTemplate: "$\"/api/v1/repos/{owner}/{repo}/owners\"",
                                httpMethod: "DELETE",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessRemoveRepoOwnerResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::LangSmith.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessRemoveRepoOwnerResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            return await RemoveRepoOwnerAsync(
                owner: owner,
                repo: repo,
                request: __request,
                requestOptions: requestOptions,
