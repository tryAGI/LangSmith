            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            if (ReadResponseAsString)
            {
                ...
                try
                {
                    ...
                    return
                        global::LangSmith.AnnotationQueueSizeSchema.FromJson(__content, JsonSerializerOptions) ??
            ...
            else
            {
                try
                {
                    ...
                    return
                        await global::LangSmith.AnnotationQueueSizeSchema.FromJsonStreamAsync(__content, JsonSerializerOptions).ConfigureAwait(false) ??
