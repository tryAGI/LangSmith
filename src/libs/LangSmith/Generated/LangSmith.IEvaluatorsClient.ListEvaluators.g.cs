...
namespace LangSmith
{
    public partial interface IEvaluatorsClient
    {
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::LangSmith.ApiException"></exception>
        global::System.Threading.Tasks.Task<global::LangSmith.AutoSDKHttpResponse<global::LangSmith.EvaluatorsListEvaluatorsResponse>> ListEvaluatorsAsResponseAsync(
            string? type = default,
            string? nameContains = default,
            global::System.Collections.Generic.IList<string>? tagValueId = default,
            string? feedbackKey = default,
