...
namespace LangSmith
{
    public partial class FleetAuthClient
    {
        ...
        private static readonly global::LangSmith.AutoSDKServer[] s_GrantAConnectionTokenToAnAgentServers = new global::LangSmith.AutoSDKServer[]
        ...
        private static readonly global::LangSmith.EndPointSecurityRequirement s_GrantAConnectionTokenToAnAgentSecurityRequirement0 =
        ...
        private static readonly global::LangSmith.EndPointSecurityRequirement[] s_GrantAConnectionTokenToAnAgentSecurityRequirements =
            new global::LangSmith.EndPointSecurityRequirement[]
            {                s_GrantAConnectionTokenToAnAgentSecurityRequirement0,
            };
        partial void PrepareGrantAConnectionTokenToAnAgentArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string agentId);
        partial void PrepareGrantAConnectionTokenToAnAgentRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string agentId);
        partial void ProcessGrantAConnectionTokenToAnAgentResponse(
            global::System.Net.Http.HttpClient httpClient,
        ...
        public async global::System.Threading.Tasks.Task GrantAConnectionTokenToAnAgentAsync(
            string agentId,
            global::LangSmith.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            await GrantAConnectionTokenToAnAgentAsResponseAsync(
                agentId: agentId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::LangSmith.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::LangSmith.AutoSDKHttpResponse> GrantAConnectionTokenToAnAgentAsResponseAsync(
            string agentId,
            global::LangSmith.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareGrantAConnectionTokenToAnAgentArguments(
            ...
            var __authorizations = global::LangSmith.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_GrantAConnectionTokenToAnAgentSecurityRequirements,
                operationName: "GrantAConnectionTokenToAnAgentAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::LangSmith.PathBuilder(
                                path: $"/v1/fleet/auth-agents/{agentId}/connections",
                                baseUri: ResolveBaseUri(
                                servers: s_GrantAConnectionTokenToAnAgentServers,
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareGrantAConnectionTokenToAnAgentRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::LangSmith.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::LangSmith.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "GrantAConnectionTokenToAnAgent",
                                methodName: "GrantAConnectionTokenToAnAgentAsync",
                                pathTemplate: "$\"/v1/fleet/auth-agents/{agentId}/connections\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessGrantAConnectionTokenToAnAgentResponse(
                    httpClient: HttpClient,
