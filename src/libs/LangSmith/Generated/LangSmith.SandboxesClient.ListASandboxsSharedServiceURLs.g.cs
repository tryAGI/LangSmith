...
namespace LangSmith
{
    public partial class SandboxesClient
    {
        ...
        private static readonly global::LangSmith.AutoSDKServer[] s_ListASandboxsSharedServiceURLsServers = new global::LangSmith.AutoSDKServer[]
        ...
        private static readonly global::LangSmith.EndPointSecurityRequirement s_ListASandboxsSharedServiceURLsSecurityRequirement0 =
        ...
        private static readonly global::LangSmith.EndPointSecurityRequirement[] s_ListASandboxsSharedServiceURLsSecurityRequirements =
            new global::LangSmith.EndPointSecurityRequirement[]
            {                s_ListASandboxsSharedServiceURLsSecurityRequirement0,
            };
        partial void PrepareListASandboxsSharedServiceURLsArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string name,
            ref int? pageSize,
            ref string? cursor);
        partial void PrepareListASandboxsSharedServiceURLsRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string name,
            int? pageSize,
            string? cursor);
        partial void ProcessListASandboxsSharedServiceURLsResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessListASandboxsSharedServiceURLsResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::LangSmith.SandboxesServiceURLGrantListResponse> ListASandboxsSharedServiceURLsAsync(
            string name,
        ...
        {
            var __response = await ListASandboxsSharedServiceURLsAsResponseAsync(
                name: name,
                pageSize: pageSize,
                cursor: cursor,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::LangSmith.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::LangSmith.AutoSDKHttpResponse<global::LangSmith.SandboxesServiceURLGrantListResponse>> ListASandboxsSharedServiceURLsAsResponseAsync(
            string name,
            int? pageSize = default,
            string? cursor = default,
            global::LangSmith.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareListASandboxsSharedServiceURLsArguments(
            ...
            var __authorizations = global::LangSmith.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_ListASandboxsSharedServiceURLsSecurityRequirements,
                operationName: "ListASandboxsSharedServiceURLsAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::LangSmith.PathBuilder(
                                ...
                                servers: s_ListASandboxsSharedServiceURLsServers,
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareListASandboxsSharedServiceURLsRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::LangSmith.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::LangSmith.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "ListASandboxsSharedServiceURLs",
                                methodName: "ListASandboxsSharedServiceURLsAsync",
                                pathTemplate: "$\"/api/v2/sandboxes/boxes/{name}/service-urls\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessListASandboxsSharedServiceURLsResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::LangSmith.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessListASandboxsSharedServiceURLsResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::LangSmith.SandboxesServiceURLGrantListResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::LangSmith.AutoSDKHttpResponse<global::LangSmith.SandboxesServiceURLGrantListResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::LangSmith.SandboxesServiceURLGrantListResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
