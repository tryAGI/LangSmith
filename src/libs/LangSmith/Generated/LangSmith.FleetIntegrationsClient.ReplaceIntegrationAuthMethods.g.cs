...
namespace LangSmith
{
    public partial class FleetIntegrationsClient
    {
        ...
        {
            var __response = await ReplaceIntegrationAuthMethodsAsResponseAsync(
                id: id,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::LangSmith.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::LangSmith.AutoSDKHttpResponse<global::LangSmith.IntegrationsIntegration>> ReplaceIntegrationAuthMethodsAsResponseAsync(
            string id,
